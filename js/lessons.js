...
window.LESSONS = {
  "intro": {
    ...
    en_lede: "What Power BI is, why analysts and businesses rely on it, and what the learning path ahead looks like.",
    sectionId: "intro",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <p>مثال بسيط: إذا كان لديك مبيعات من Excel، ومصاريف من نظام محاسبة، وأهداف شهرية من ملف آخر، فدور Power BI هو جمع هذه المصادر وتنظيفها وربطها ثم عرض مؤشرات مثل الإيراد، الربح، أفضل منتج، أسوأ فرع، واتجاه الأداء عبر الوقت.</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <p>قبل أن تسأل: "أعمل أي Chart؟" اسأل أولًا: "ما القرار الذي نحاول تحسينه؟" لأن التقرير الناجح يبدأ من سؤال واضح، وليس من شكل بصري جميل.</p>
      <ul>
    ...
    <div class="lesson-card">
      ...
      <table class="compare-table">
        ...
        <tr>
          ...
          <td>يجب تنظيف البيانات في Power Query، وتبني علاقات صحيحة، وتكتب مقاييس DAX واضحة قبل أن تثق في التقرير.</td>
        </tr>
        <tr>
    ...
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Power BI isn't just a tool for drawing charts</h3>
    ...
    <div class="lesson-card">
      ...
      <p>Business Intelligence is the process of turning raw data into understandable information — and then into insights that drive decisions. The word "intelligence" here doesn't mean the tool thinks for you. It means the tool gives you a better way to read reality through numbers.</p>
      <table class="compare-table">
        <tr>
          <th>Level</th>
          <th>Meaning</th>
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>You connect tables with the right relationships and separate Fact tables from Dimension tables so your numbers don't become misleading.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">4</div>
  ...
  "setup": {
    ...
    en_lede: "Get Power BI Desktop installed and your workspace ready in a few minutes.",
    sectionId: "setup",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>اختار النسخة الصحيحة من البداية</h3>
      <p>أنت غالبًا تحتاج Power BI Desktop العادي، وليس Power BI Report Server Desktop. النسخة العادية هي الأفضل للتعلم ولأغلب العمل الحديث لأنها مرتبطة بتحديثات Power BI Service والميزات الجديدة.</p>
      <table class="compare-table">
        <tr>
          <th>النسخة</th>
          <th>الاستخدام</th>
    ...
    <div class="steps">
      ...
      <div class="step">
        ...
        <div class="step-content">
          ...
          <p>إذا لم تستطع استخدام المتجر، ادخل على موقع Microsoft الرسمي وحمّل Power BI Desktop. تجنب مواقع التحميل غير الرسمية حتى لا تحمل نسخة قديمة أو ملف غير موثوق.</p>
        </div>
      </div>
      <div class="step">
        <div class="step-num">3</div>
      ...
      <div class="step">
        ...
        <div class="step-content">
          ...
          <p>إذا كانت بياناتك فيها تواريخ أو أرقام بتنسيق مختلف، راجع إعدادات Regional Settings من Options. أخطاء اليوم والشهر والفواصل العشرية من أكثر أسباب النتائج الغريبة في بداية التعلم.</p>
        </div>
      </div>
    </div>
    ...
    <div class="warn-box">
      ...
      <p><strong>تنبيه:</strong> Power BI Desktop لا يعمل مباشرة على macOS. إذا كان جهازك Mac ستحتاج Windows عبر Parallels أو Boot Camp أو جهاز Windows منفصل.</p>
    </div>
...
<div class="steps">
  ...
  <div class="step">
    ...
    <div class="step-content">
      ...
      <p>If you can't use the Store, visit the official Microsoft website and download Power BI Desktop. Avoid unofficial download sites to ensure you get the latest, trusted version.</p>
    </div>
  </div>
  <div class="step">
    <div class="step-num">3</div>
    <div class="step-content">
      ...
      <p>Open the app and confirm the home screen appears without errors. Signing in with a work or school account is useful for publishing later, but it isn't required to build your first local report.</p>
    </div>
  </div>
  <div class="step">
    <div class="step-num">4</div>
...
<div class="warn-box">
<div class="icon">⚠️</div>
<p><strong>Warning:</strong> Power BI Desktop doesn't run natively on macOS. If you're on a Mac, you'll need Windows via Parallels, Boot Camp, or a separate Windows machine.</p>
</div>
...
<p><strong>Mac alternative:</strong> You can use Power BI Service (app.powerbi.com) directly in a browser on any operating system. Some tasks — such as building reports and creating measures — are available there without needing Desktop.</p>
  ...
  "interface": {
    ...
    en_lede: "A walkthrough of Power BI Desktop's main screens, panes, and tools — and when you'll use each one.",
    sectionId: "interface",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>📍 أنت هنا في الرحلة</h3>
      <p>في الدرس السابق تعرفت على مكونات Power BI الثلاثة: Desktop (بناء)، Service (نشر)، Mobile (متابعة). الآن سنركز على Desktop والأدوات التي تساعدك في <strong>كل مرحلة من مراحل بناء التقرير</strong>.</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <p>على اليمين ستجد مجموعة panes تختلف قليلًا حسب إصدار Power BI Desktop والإعدادات المفعلة:</p>
      <ul>
        ...
        <li><strong>Build Pane / Build a visual:</strong> في هذه الواجهة الحديثة تستبدل جزء كبير من الـ Visualizations Pane وتستخدمها لاختيار نوع الـ visual وتوزيع الحقول عليه.</li>
        <li><strong>Format Pane:</strong> منها تتحكم في الألوان، العناوين، الـ labels، الخلفيات، وأسلوب عرض الـ visual.</li>
        <li><strong>Visualizations Pane:</strong> قد تجد هذا الاسم في الشروحات القديمة أو إذا كانت إعداداتك على الشكل القديم بعد؛ وهو كان يجمع بين البناء والتنسيق في pane واحدة.</li>
        <li><strong>Panes إضافية عند الحاجة:</strong> مثل Bookmarks - Selections - Sync Slicers — تفتحها من قائمة View حسب العمل الذي تنفّذه.</li>
      </ul>
    </div>

    <div class="lesson-card">
      <h3>⬇️ الخطوة القادمة: فهم البيانات التي تعمل معاها</h3>
      <p>الآن تعرف أين تذهب البيانات في Power BI (Data Pane) وكيف تحولها لـ Visuals. لكن <strong>قبل أن تشرع في بناء، يجب فهم نوع البيانات التي تتعامل معاها</strong>:</p>
      <ul>
        <li>من أين تأتي البيانات؟ من نظام تشغيلي (مثل SAP أو نظام المبيعات) أم من Data Warehouse المُجهَّزة للتحليل؟</li>
        <li>هل البيانات متحدّثة لحظياً أم تاريخية متراكمة؟</li>
        <li>كيف هذا يؤثر على طريقة بناء النموذج؟</li>
      </ul>
      <p><strong>الدرس القادم (OLTP vs OLAP)</strong> سيجيب على كل هذه الأسئلة ويشرح لك الفرق بين النظامين — وهذا أساسي قبل أن تشرع في نمذجة البيانات.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
<h3>📍 Where you're on the journey</h3>
<p>You've already covered Power BI's three components — Desktop (build), Service (publish), Mobile (monitor). Now let's focus on Desktop and the tools that help you in <strong>every stage of report building</strong>.</p>
</div>
...
<p>On the right you'll find a set of panes that may vary slightly depending on your Power BI Desktop version and enabled settings:</p>
<ul>
...
<p><strong>Next Lesson (OLTP vs OLAP)</strong> will answer all these questions and explain the difference between the two systems — essential knowledge before you start modeling your data.</p>
  ...
  "oltp-olap": {
    ...
    lede: "قبل أن تبدأ تبني أي نموذج بيانات، يجب فهم الفرق الجوهري بين النظامين التي تتعامل معاهم في عالم البيانات.",
    en_eyebrow: "01 · 04 — OLTP vs OLAP",
    en_lede: "OLTP runs the business; OLAP analyzes it. Understanding the difference shapes every modeling decision you'll make.",
    sectionId: "oltp-olap",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>أولًا: أنت تعرف الفكرة بالفعل حتى وإن لم تسمع الاسم</h3>
    ...
    <div class="tip-box">
      <div class="icon">🧠</div>
      <p><strong>سطر للحفظ السريع:</strong> OLTP = "تشغيل العمل"، بينما OLAP = "فهم العمل".</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>نوع العمل:</strong> عمليات صغيرة جدًا لكنها كثيرة جدًا: Insert, Update, Delete, Select لسجل أو عدد قليل من السجلات.</li>
    ...
    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>مهم:</strong> النظام التشغيلي الممتاز ليس بالضرورة مريحًا للتحليل. قد يكون ممتازًا للعمليات اليومية لكنه سيئ جدًا إذا حاولت أن تحلل عليه مباشرة.</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>نوع العمل:</strong> Aggregations, Trends, Comparisons, KPIs, slicing, filtering عبر فترات طويلة.</li>
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>لأن OLTP حساس للضغط:</strong> إذا شغّلت عليه تقارير ثقيلة، قد تبطّئ النظام الذي يسجل المبيعات أو الطلبات الفعلية.</li>
      ...
      <p>لذلك في العالم الواقعي، أنت غالبًا لا تأخذ Power BI وتوصله على قاعدة تشغيلية خام ثم تنتهي. هناك دائمًا طبقة تجهيز، حتى وإن كانت بسيطة، بين المصدر التشغيلي والطبقة التحليلية، وغالبًا تمر هذه الرحلة عبر Data Warehouse أو طبقة تحليلية مشابهة.</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <p>إذا كنت تبني تقارير في Power BI، فأنت غالبًا تعمل في العالم التحليلي حتى وإن كان المصدر النهائي جايًا من نظام تشغيلي.</p>
      <ul>
...
<p>Simply put: <strong>OLTP writes the event</strong>, while <strong>OLAP reads thousands or millions of events to interpret them</strong>.</p>
</div>
...
<div class="steps">
  ...
  <div class="step">
    ...
    <div class="step-content">
      ...
      <p>Throughout the day many transactions accumulate. The operational system isn't concerned with asking "what's the monthly trend?" — it just needs every transaction recorded without failure.</p>
    </div>
  </div>
  <div class="step">
    <div class="step-num">3</div>
...
<p>OLTP isn't designed to give you a nice Dashboard. It is designed so that daily business doesn't break down.</p>
<ul>
...
<div class="warn-box">
<div class="icon">⚠️</div>
<p><strong>Important:</strong> An excellent operational system isn't necessarily comfortable for analysis. It can be outstanding for daily transactions but very poor if you try to analyze directly on top of it.</p>
</div>

<div class="lesson-card">
<h3>What exactly does OLAP need?</h3>
<p>OLAP or an analytical environment cares about the big question, not the individual transaction. It wants to read a huge volume of data quickly and summarize it in a way that's useful for decision-making.</p>
<ul>
...
<li><strong>Queries:</strong> Usually more complex queries with joins and large aggregations, because they're trying to understand the full picture, not just one transaction.</li>
...
<p>That is why Power BI doesn't like working with raw operational data as-is — it usually needs cleaning and reshaping before it becomes comfortable and fast to analyze.</p>
</div>

<div class="lesson-card">
<h3>Why not analyze directly on OLTP?</h3>
<p>This is a very fundamental question, and it's almost the entire point of this lesson.</p>
<ul>
...
<li><strong>Because analytical definitions aren't ready:</strong> Profit, growth, time comparisons, customer segmentation — these aren't the operational system's questions to begin with.</li>
...
<p>If you're building reports in Power BI, you're generally working in the analytical world — even if the data source ultimately comes from an operational system.</p>
<ul>
...
<li><strong>Data Warehouse / Analytical Layer:</strong> In larger organizations, data doesn't go directly from the operational system to the report — it passes through an intermediate layer that organizes, aggregates, and prepares it for analysis.</li>
...
<p><strong>Golden rule to remember:</strong> OLTP builds the truth moment by moment, and OLAP explains the truth after it accumulates. Your job as an analyst is to take data from the operational world and transform it into the world of understanding.</p>
  ...
  "model": {
    ...
    en_lede: "Star Schema is the foundation of every solid Power BI model. Here's what it's and why it matters.",
    sectionId: "model",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>🎯 أنت هنا في الرحلة — من فهم الأنظمة إلى بناء النموذج</h3>
      <p><strong>ما فهمته لحد الآن:</strong></p>
      <ul>
        <li>Power BI تتحوّل خام البيانات → رؤى واتخاذ قرار</li>
        <li>البيانات تبدأ من OLTP (معقد، مكرر) وتنتقل لـ OLAP (منسق، تحليلي)</li>
      </ul>
      ...
      <p>هذا النموذج ليس مجرد "تنظيم أكاديمي" — هو الأساس الذي تبني عليه:</p>
      <ul>
        <li>فلاترك (لأن الأعمدة الفريدة في Dimensions)</li>
        <li>معادلات DAX الخاصة بك (بسبب الفصل بين Fact و Dimension)</li>
        <li>سرعة التقرير (لأن الجداول صغيرة ومترابطة بشكل ذكي)</li>
      </ul>
    </div>

    <div class="lesson-card">
      <h3>لماذا لا نستخدم جدول واحد كبير؟ (Flat Table)</h3>
      <p>في الإكسيل متعودين نحط كل البيانات في شيت واحد كبير. في Power BI هذا يُسبّب بطء شديد وتكرار للبيانات. الصح هو تقسيم البيانات.</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>تسهيل التوسع:</strong> عند إضافة جداول أو KPIs جديدة، لا ينهار العمل كله من جديد.</li>
      </ul>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>Snowflake Schema:</strong> مشابه للـ Star لكن فيه الـ Dimensions نفسها متفرعة إلى جداول إضافية. أحيانًا مفيد، لكنه غالبًا أعقد من اليجب للمبتدئ.</li>
      </ul>
    ...
    <div class="tip-box">
      <div class="icon">⭐</div>
      <p><strong>Star Schema:</strong> هو أفضل تصميم، وفيه يكون الـ Fact Table في المنتصف، ومحاط بـ Dimension Tables مثل النجمة.</p>
    </div>
...
` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
<h3>🎯 Where you're in the journey — From understanding systems to building the model</h3>
...
<p>This model isn't just "academic organization" — it's the foundation you build on:</p>
<ul>
...
<p>In practical terms: the Data Model isn't just tables that exist inside the file — it's the logical map that lets Power BI understand how filters flow, how numbers aggregate, and how results come out correct.</p>
</div>

<div class="lesson-card">
<h3>What is the Data Model's goal?</h3>
<ul>
<li><strong>Produce correct numbers:</strong> So results aren't duplicated or inflated by a bad design.</li>
...
<li><strong>Make scaling easier:</strong> When you add new tables or KPIs, the whole project doesn't collapse.</li>
</ul>
</div>

<div class="tip-box">
<div class="icon">💡</div>
<p><strong>Key idea:</strong> A beautiful report can't save a bad model. But a good model makes even the simplest report trustworthy and extensible.</p>
</div>

<div class="lesson-card">
<h3>What is a Schema? And what are the most common types?</h3>
<p>The word Schema means the shape of how tables and relationships are organized — that's, how you arranged data inside the model.</p>
<ul>
...
<p>This lesson focuses on Star Schema because it's the most common, the clearest, and usually the best choice in Power BI.</p>
</div>
...
<td>Data is unique and doesn't repeat (each customer has one code only).</td>
</tr>
</table>
...
<li><strong>Size matters:</strong> If a Dimension Table has more than 10 million rows, you're storing data that should be in a Fact Table. Re-evaluate the model.</li>
<li><strong>Keys:</strong> Use surrogate keys (artificial keys: 1, 2, 3...) instead of natural keys. Faster and safer for joins.</li>
<li><strong>Performance first:</strong> Test the model with a small dataset first (1,000 rows). If there's a problem, find it early.</li>
<li><strong>Document it:</strong> Record <em>why</em> your model looks the way it does. Six months from now, even you won't remember!</li>
  ...
  "scd": {
    eyebrow: "01 · 06 — البيانات المتغيرة عبر الوقت",
    title: "البيانات المتغيرة عبر الوقت (SCD) — Slowly Changing Dimensions",
    lede: "ماذا يحدث إذا العميل غيّر عنوانه أو انتقل الموظف لفرع آخر؟ SCD هي الإجابة على هذا السؤال الأساسي في هندسة البيانات.",
    en_eyebrow: "01 · 06 — Slowly Changing Dimensions",
    en_lede: "What happens when a customer moves cities or an employee switches branches? SCD is how you track dimension changes over time.",
    sectionId: "scd",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>ما هي المشكلة؟</h3>
      <p>في الواقع، بيانات الـ Dimension تتغير مع الوقت. إذا مدير فرع انتقل من القاهرة للإسكندرية في يوليو، هل تقارير ما قبل يوليو تعكس القاهرة أم الإسكندرية؟ الإجابة تعتمد على نوع الـ SCD الذي تختاره.</p>
    </div>
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>مهم جدًا:</strong> هذا المثال هدفه شرح الفكرة، وليس أن يحفظ المتدرب الصيغة. إذا فهم أن اختيار الصف يتم حسب الموظف + تاريخ البيع، فهو فهم جوهر Type 2.</p>
    </div>
    ...
    <div class="lesson-card lesson-card-wide lesson-card-example-table">
      ...
      <p><strong>مثال سريع:</strong> إذا الكود يقرأ الصف الذي فيه <strong>SaleID = 101</strong>، فسيرى أن الموظف هو <strong>E001</strong> وأن تاريخ البيع هو <strong>2024-03-15</strong>. بعدها سيبحث داخل <code>Dim_Employee</code> عن صف أحمد الذي تشمل فترة صلاحيته هذا التاريخ، وبالتالي ستكون النتيجة هي <strong>Giza</strong>.</p>
    </div>
...
<td>When history doesn't matter, such as fixing a typo.</td>
</tr>
<tr>
...
<p>The important idea here is that we don't rely on <strong>EmployeeID</strong> alone, because the same employee can appear in more than one historical row inside <code>Dim_Employee</code>.</p>
<ul>
<li><strong>EmployeeID</strong> is the business identity of the employee, so it can repeat across multiple rows.</li>
<li><strong>EmployeeKey</strong> is the unique key for each historical version of the employee, so it doesn't repeat.</li>
<li>If we are reading an old sale, we want the employee information <strong>as it was at the time of the sale</strong>, not as it's today.</li>
</ul>
...
<span class="cm">-- Find the historical row that's valid on the sale date</span>
...
<p>If all conditions are true, that's the historical row we want, and that's where the branch value comes from.</p>
</div>

<div class="tip-box">
<div class="icon">✅</div>
<p><strong>Bottom line:</strong> the goal here isn't to memorize DAX. If the learner understands that the correct row is chosen using <strong>employee + sale date</strong>, then they have understood the heart of Type 2.</p>
</div>` }],
  },  "bridge-tables": {
    ...
    en_lede: "Many-to-Many relationships break filters when handled wrong. Bridge tables are the clean, professional fix.",
    sectionId: "bridge-tables",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>المشكلة — لماذا Many-to-Many خطيرة؟</h3>
      <p>إذا ربطت جدولين مباشرة بعلاقة Many-to-Many (مثلاً: طالب ← مادة وكل طالب له مواد متعددة وكل مادة فيها طلاب متعددين)، Power BI يحتاج لحل وسيط لأن الفلاتر ستنتشر بشكل غير متحكم فيه وتعطي أرقاماً مضاعفة.</p>
    </div>
...
<p>If you connect two tables directly with a relationship Many-to-Many (for example: student ← A subject and each student has multiple subjects, and each subject has multiple students), Power BI needs an intermediate solution because filters spread uncontrollably and produce doubled numbers.</p>
</div>
<div class="lesson-card">
...
<li>In some cases you'll need <strong>CROSSFILTER</strong> in DAX To pass the filter manually</li>
</ul>
<div class="code-block">
...
<p><strong>warning:</strong> Avoid activation Cross-filter Direction = Both On the relationships directly in the model Many-to-Many — use CROSSFILTER in DAX Instead of precise control.</p>
  ...
  "getdata": {
    ...
    en_lede: "Connect Power BI to Excel, SQL, SharePoint, APIs, and more — and understand what happens when you do.",
    sectionId: "getdata",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
    ...
    <div class="steps">
      <div class="step">
        ...
        <div class="step-content">
          <h4>Home → Get Data</h4>
          <p>من شريط الأدوات العلوي، انقر على "Get Data" واختر مصدر البيانات الخاص بك (Excel, SQL Server, Web, إلخ).</p>
        </div>
      </div>
      <div class="step">
        <div class="step-num">2</div>
      ...
      <div class="step">
        ...
        <div class="step-content">
          ...
          <p><strong>Load (الخيار السريع):</strong> استورد البيانات كما هي مباشرة إلى النموذج. استخدمه فقط إذا البيانات نظيفة تماماً.</p>
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>❌ "Could not find file":</strong> تحقق من المسار والملف موجود. إذا الملف على محرك USB أو Shared Drive، قد يتغير الـ Path.</li>
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>نصيحة:</strong> احفظ اتصالاتك المتكررة كـ "Query" مسماة. بهذا إذا احتجت تحديثها لاحقاً، تقدر تعدّل Query واحدة وكل التقارير تحديثت تلقائياً.</p>
    </div>
...
<p><strong>Warning:</strong> When connecting to company network database (On-Premises), you may need to install Data Gateway. Without it, Power BI Service can't refresh data in the cloud.</p>
  ...
  "cleaning": {
    ...
    lede: "أشهر الأدوات التي ستحتاجها في Power Query لتجهيز بياناتك.",
    en_eyebrow: "02 · 02 — Data Cleaning",
    en_lede: "The essential Power Query tools for fixing messy data before it reaches your model.",
    sectionId: "cleaning",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <ul>
        <li><strong>Column Distribution:</strong> كام فريق قيمة مختلفة في العمود؟ هل فيه Values مكررة كثير؟</li>
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>Remove Errors:</strong> حذف الصفوف التي فيها #Error (أرقام محفوظة غلط أو قيمة مفقودة). Right-click على رقم الصف ← Remove Errors.</li>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li>مثال عملي: تصنيف العملاء حسب الإنفاق (من بيانات Import).</li>
      </ul>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>Append Queries:</strong> دمج جدولين بالطول (وضع بيانات الشهر الثاني أسفل بيانات الشهر الأول).</li>
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>نصيحة ذهبية:</strong> كل خطوة تنظيف تسجل في Power Query M-code تلقائياً. إذا مصدر البيانات محدّث، الخطوات تطبق تلقائياً. هذا السحر الحقيقي للـ Power Query!</p>
    </div>

    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>تحذير:</strong> لا تحذف البيانات الخام من المصدر. احفظ Query خاصة بالبيانات الخام (Staging)، ثم ابنِ Queries محسّنة تعتمد عليها. بهذا إذا احتجت العودة للخام، تقدر.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
...
<p><strong>Warning:</strong> Don't delete raw data from source. Keep a Staging query for raw data, then build optimized queries on top. This way you can revert to raw if needed.</p>
  ...
  "powerquery": {
    ...
    lede: "المطبخ السري لـ Power BI. كل خطوة تُسجَّل تلقائياً وتُطبَّق كل مرة تحدّث البيانات.",
    en_eyebrow: "02 · 03 — Power Query Editor",
    en_lede: "Power Query records every transformation step and replays it automatically on refresh. This is where data prep lives.",
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>الميزة الخارقة:</strong> كل خطوة تُسجَّل في <strong>Applied Steps</strong>. لما البيانات تتحدث، الخطوات تتنفذ تلقائياً بدون تدخل.</p>
    </div>
...
<span class="cm">-- الخطوة: select columns Jan,Feb,Mar → Transform → Unpivot Columns</span>
    ...
    <div class="lesson-card">
      <h3>🏆 Pro Tips من الخبرة الميدانية</h3>
      <ul>
        <li><strong>Change Type أول خطوة:</strong> كل استعلام جديد، غيّر نوع الأعمدة أول شيء. هذا يوفر مشاكل كثيرة في DAX لاحقاً.</li>
...
<p>Power Query is Power BI's built-in ETL engine. Its job:</p>
<ul>
...
<div class="tip-box">
<div class="icon">💡</div>
<p><strong>Key feature:</strong> Every action you take is saved as a step in the <strong>Applied Steps</strong> list. When the data refreshes, all steps replay automatically — no manual work needed.</p>
</div>
<div class="lesson-card">
...
<li><strong>Add Custom Column:</strong> Add a new column using M code expressions.</li>
</ul>
</div>
<div class="lesson-card">
<h3>Merge vs Append</h3>
<ul>
<li><strong>Merge Queries:</strong> Join two tables on a shared column — a far more powerful alternative to VLOOKUP. Supports Left, Right, Inner, and Full joins.</li>
...
<li><strong>Applied Steps = Security:</strong> Every step is automatically logged, so you can go back to any step if you make a mistake, or see how many times the steps have been updated.</li>
  ...
  "pq-groupby": {
    eyebrow: "02 · 04 — Group By وPivot/Unpivot والـ Parameters",
    title: "Group By وPivot/Unpivot والـ Parameters",
    lede: "ثلاث أدوات في Power Query تحل 80% من مشكلات تشكيل البيانات — التجميع، قلب الجداول، والمتغيرات الديناميكية.",
    en_eyebrow: "02 · 04 — Group By, Pivot/Unpivot & Parameters",
    en_lede: "Three Power Query tools that solve 80% of data-shaping problems: aggregating with Group By, reshaping with Pivot/Unpivot, and building dynamic queries with Parameters.",
    sectionId: "pq-groupby",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Group By — تجميع البيانات</h3>
      <p>Group By في Power Query يشبه GROUP BY في SQL — يجمّع الصفوف ويحسب قيمة واحدة لكل مجموعة.</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Home → Group By</h4>
            <p>اختر العمود الذي تريد التجميع بناءً عليه (مثل: Region أو Category).</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>حدد عملية التجميع</h4>
            <p>Sum للمجموع، Average للمتوسط، Count لعد الصفوف، Min/Max للأدنى والأعلى، أو All Rows للاحتفاظ بالتفاصيل داخل قائمة.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Advanced Mode — تجميع متعدد</h4>
            <p>اضغط Advanced لإضافة أكثر من عمود تجميع أو أكثر من عملية في نفس الخطوة.</p>
          </div>
        </div>
      </div>
      <div class="code-block">
        <span class="cm">-- M Code المولَّد تلقائيًا بعد Group By</span>
= Table.Group(
    Source,
    {"Region"},                        <span class="cm">-- عمود التجميع</span>
    {
    ...
    <div class="lesson-card">
      <h3>Unpivot — تحويل الأعمدة إلى صفوف</h3>
      <p>أكثر عملية تحتاجها عند استيراد بيانات من Excel بتنسيق "عريض" (كل شهر عمود منفصل). الـ Unpivot يحوّلها إلى تنسيق "طولي" مناسب للنمذجة.</p>
      <table class="compare-table">
        <tr><th>قبل Unpivot (عريض)</th><th>بعد Unpivot (طولي)</th></tr>
        <tr><td>Region | Jan | Feb | Mar</td><td>Region | Month | Value</td></tr>
        <tr><td>North  | 100 | 120 | 90</td><td>North  | Jan   | 100</td></tr>
        <tr><td>South  | 80  | 95  | 110</td><td>North  | Feb   | 120</td></tr>
      </table>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>حدد الأعمدة الثابتة أولاً</h4>
            <p>حدد الأعمدة التي لا تريد قلبها (مثل Region وProduct).</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Unpivot Other Columns</h4>
            <p>كليك يمين على التحديد → Unpivot Other Columns. هذا يحافظ على الأعمدة المحددة ويقلب الباقي.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-card">
      <h3>Pivot — العكس: صفوف إلى أعمدة</h3>
      <p>نادر الاستخدام في التحليل، لكن مفيد لإنشاء جداول مقارنة أو تقارير مصفوفة.</p>
      <div class="code-block">
        <span class="cm">-- Unpivot: أعمدة → صفوف (الأكثر استخدامًا)</span>
= Table.UnpivotOtherColumns(Source, {"Region", "Product"}, "Month", "Value")

        <span class="cm">-- Pivot: صفوف → أعمدة</span>
= Table.Pivot(Source, List.Distinct(Source[Month]), "Month", "Value", List.Sum)
      </div>
    </div>

    <div class="lesson-card">
      <h3>Parameters — متغيرات ديناميكية</h3>
      <p>الـ Parameters تسمح بتغيير مسار الملف أو اسم الخادم أو نطاق التاريخ من مكان واحد دون تعديل الاستعلام يدويًا في كل مرة.</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Home → Manage Parameters → New Parameter</h4>
            <p>أنشئ Parameter باسم مناسب مثل FilePath أو ServerName مع تحديد النوع (Text أو Date).</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>استخدمه في الاستعلام</h4>
            <p>بدلاً من مسار ثابت، استخدم اسم الـ Parameter مباشرةً في الـ M Code.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>الفائدة الكبرى: Query Parameters في Service</h4>
            <p>عند النشر، يمكن لمسؤول الـ Service تغيير قيمة الـ Parameter بدون فتح Power BI Desktop.</p>
          </div>
        </div>
      </div>
      <div class="code-block">
        <span class="cm">-- قبل: مسار ثابت مشفّر</span>
= Excel.Workbook(File.Contents("C:\data\sales_2024.xlsx"))

        <span class="cm">-- بعد: Parameter ديناميكي</span>
= Excel.Workbook(File.Contents(FilePath))
        <span class="cm">-- FilePath هو Parameter يمكن تغييره من الواجهة</span>
      </div>
    </div>

    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>متى تستخدم كل أداة:</strong> Group By لتلخيص البيانات قبل تحميلها — Unpivot لتحويل جداول Excel العريضة إلى تنسيق نمذجة — Parameters لأي قيمة قد تتغير بين بيئة التطوير والإنتاج.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Group By — aggregate before you load</h3>
      <p>Group By in Power Query is the equivalent of SQL's GROUP BY — it collapses rows and computes one value per group.</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Home → Group By</h4>
            <p>Select the column to group by (e.g. Region or Category).</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Choose the aggregation</h4>
            <p>Sum, Average, Count, Min, Max — or All Rows to keep the detail as a nested table.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Advanced mode — multiple aggregations</h4>
            <p>Click Advanced to group by multiple columns or compute several aggregations in one step.</p>
          </div>
        </div>
      </div>
      <div class="code-block">
        <span class="cm">-- M Code generated automatically after Group By</span>
= Table.Group(
    Source,
    {"Region"},                        <span class="cm">-- group-by column</span>
    {
        {"Total Sales", each List.Sum([Amount]), type number},
        {"Order Count", each Table.RowCount(_), Int64.Type}
    }
    ...
    <div class="lesson-card">
      <h3>Unpivot — turn columns into rows</h3>
      <p>This is the transformation you'll need most when importing Excel data in "wide" format (one column per month). Unpivot converts it into the "tall" format that Power BI models require.</p>
      <table class="compare-table">
        <tr><th>Before Unpivot (wide)</th><th>After Unpivot (tall)</th></tr>
        <tr><td>Region | Jan | Feb | Mar</td><td>Region | Month | Value</td></tr>
        <tr><td>North  | 100 | 120 | 90</td><td>North  | Jan   | 100</td></tr>
        <tr><td>South  | 80  | 95  | 110</td><td>North  | Feb   | 120</td></tr>
      </table>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Select the columns you want to keep fixed</h4>
            <p>Hold Ctrl and select Region, Product — anything that isn't a pivot column.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Right-click → Unpivot Other Columns</h4>
            <p>Power Query keeps your selected columns and unpivots everything else into Attribute and Value pairs.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-card">
      <h3>Pivot — the reverse: rows into columns</h3>
      <p>Less common in analysis work, but useful for building comparison tables or matrix-style reports.</p>
      <div class="code-block">
        <span class="cm">-- Unpivot: columns → rows (most common)</span>
= Table.UnpivotOtherColumns(Source, {"Region", "Product"}, "Month", "Value")

        <span class="cm">-- Pivot: rows → columns</span>
= Table.Pivot(Source, List.Distinct(Source[Month]), "Month", "Value", List.Sum)
      </div>
    </div>

    <div class="lesson-card">
      <h3>Parameters — dynamic query variables</h3>
      <p>Parameters let you change a file path, server name, or date range from one place without manually editing each query every time the environment changes.</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Home → Manage Parameters → New Parameter</h4>
            <p>Create a Parameter named FilePath or ServerName, set the type (Text, Date, Number), and give it a default value.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Reference it in your query</h4>
            <p>Replace the hardcoded value in the M expression with the Parameter name.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>The big win: override in Service</h4>
            <p>After publishing, an admin can update the Parameter value in Power BI Service without ever opening Power BI Desktop.</p>
          </div>
        </div>
      </div>
      <div class="code-block">
        <span class="cm">-- Before: hardcoded path</span>
= Excel.Workbook(File.Contents("C:\data\sales_2024.xlsx"))

        <span class="cm">-- After: dynamic Parameter</span>
= Excel.Workbook(File.Contents(FilePath))
        <span class="cm">-- FilePath is a Parameter you can update from the UI</span>
      </div>
    </div>

    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>When to use each:</strong> Group By to summarize data before it loads into the model — Unpivot to fix wide Excel tables — Parameters for any value that might differ between development and production environments.</p>
    </div>` }],
  },
  "mcode": {
...
Source = Excel.Workbook(<span class="fn">File.Contents</span>(FilePath &amp; <span class="str">"sales.xlsx"</span>))
    ...
    <div class="lesson-card">
      ...
      <p>إذا كان لديك نفس خطوات التنظيف على ملفات كثيرة، حوّلها لـ Function وادعيها مرة واحدة:</p>
      <div class="code-block">
...
<span class="kw">in</span>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>Parameters = Flexibility:</strong> استخدم Parameters لأي قيمة تتغير (مسار ملف، تاريخ، تصفية). هذا يجعل الـ Query قابلة لإعادة الاستخدام.</li>
        <li><strong>Custom Functions = Reusability:</strong> لما تكرر نفس الخطوات على ملفات مختلفة، حوّلها لـ Function. أسهل وأسرع.</li>
        <li><strong>Error Handling مهم:</strong> استخدم try-catch عند قراءة ملفات خارجية. إذا الملف لا يوجد أو فاسد، بدل الـ Query تفشل، أرجع قيمة افتراضية.</li>
...
<li><strong>Performance: Reduce Table Scans:</strong> When you do Folder Connector, filter files first (by name or size) before opening the data.</li>
  ...
  "relationships": {
    ...
    en_lede: "How to link tables correctly so filters flow the right way through your model.",
    ...
    <div class="lesson-card">
      <h3>🏆 Pro Tips من الخبرة الميدانية</h3>
      <ul>
        <li><strong>1 to Many = الوضع الصحيح:</strong> إذا شُفت Many to Many، فكّر في إضافة Bridge Table بدل قبول العلاقة الخطيرة.</li>
        ...
        <li><strong>Single Direction = الأصل الآمن:</strong> ابقَ على Single Direction في كل الأحوال. إذا كنت بحاجة filtering عكسي، استخدم CROSSFILTER في DAX.</li>
        <li><strong>اختبر الـ Cross-Filters:</strong> الفلترة ثنائية الاتجاه تؤثر على كل الـ visuals. إذا فعّلتها، اختبر كل الـ dashboard لتتأكد من النتائج.</li>
        <li><strong>المشكلة الخفية: Ambiguous Relationships:</strong> إذا هناك أكثر من علاقة ممكنة بين جدولين، Power BI قد تختار الخطأ تلقائياً وتعطيك نتائج خاطئة.</li>
      </ul>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Types of relationships (Cardinality)</h3>
      <ul>
        <li><strong>One to Many (1:*):</strong> The ideal — and always preferred — type. One customer in the Customers table can have many transactions in the Sales table.</li>
        <li><strong>One to One (1:1):</strong> Rare. Usually signals that the two tables should be merged into one.</li>
        <li><strong>Many to Many (*:*):</strong> Dangerous and worth avoiding — it causes incorrect calculation results. Use a Bridge table instead.</li>
      </ul>
    </div>
    <div class="lesson-card">
      <h3>Cross Filter Direction</h3>
      <p>The arrow on the relationship line shows which way filters travel:</p>
      <ul>
        <li><strong>Single:</strong> Filters flow from Dimension tables to the Fact table. This is the default and the safest choice.</li>
        <li><strong>Both:</strong> Filters flow in both directions. Use it with extreme caution — it slows the model and can cause ambiguous results.</li>
      </ul>
    </div>
    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p>Always make sure the columns you're joining on (like Product ID) share the same data type in both tables.</p>
    </div>
    <div class="warn-box">
      <div class="icon">🚨</div>
      <p><strong>Why bidirectional filters are risky:</strong> Switching a relationship to "Both" can seem like an easy fix, but it creates three real problems: (1) it slows the model significantly because the engine evaluates extra filter paths, (2) it produces incorrect results when there's an implicit Many-to-Many, and (3) it makes debugging very hard. The right approach: stay with Single Direction and use <strong>CROSSFILTER()</strong> in DAX only where you actually need it.</p>
    </div>
    <div class="lesson-card">
      <h3>🏆 Field tips</h3>
      <ul>
        <li><strong>One-to-Many = the right shape:</strong> If you see Many-to-Many, think Bridge table — don't accept the dangerous relationship.</li>
        <li><strong>Check data types first:</strong> Most relationship errors come from an ID column being text in one table and an integer in another. Power BI won't connect them.</li>
        <li><strong>Single Direction as the default:</strong> Start with Single on everything. Switch to Both only when there's no other option.</li>
        <li><strong>Test cross-filters:</strong> Bidirectional filtering affects every visual. If you enable it, test the full report to confirm all results are still correct.</li>
        <li><strong>Ambiguous relationships:</strong> When multiple relationship paths exist between two tables, Power BI may pick the wrong one silently and give incorrect results.</li>
      </ul>
    </div>` }],
  },
  "datetable": {
    ...
    en_lede: "Time Intelligence functions need a proper calendar table. Without one, YTD, YoY, and MTD won't work correctly.",
    sectionId: "datetable",
    blocks: [{ kind: "html", html: `<div class="warn-box">
      <div class="icon">🚨</div>
      <p><strong>قاعدة يجب تعرفها:</strong> Power BI لا يقبل دوال Time Intelligence (TOTALYTD, SAMEPERIODLASTYEAR...) إلا إذا كان عندك جدول تقويم مستمر (بدون فجوات في التواريخ) ومعلّم كـ Date Table.</p>
    </div>

    <div class="lesson-card">
      <h3>الطريقة 1 — CALENDARAUTO() (أسرع طريقة)</h3>
      <p>تعمل جدول تلقائي من أصغر تاريخ لأكبر تاريخ موجود في النموذج كله. استخدمها إذا كانت بياناتك مكتملة:</p>
      <div class="code-block">
...
<span class="fn">ADDCOLUMNS</span>(
    ...
    <div class="lesson-card">
      ...
      <p>تحدد أنت نطاق التواريخ بدقة. مفيد إذا كان لديك بيانات مستقبلية أو تاريخية خارج نطاق البيانات:</p>
      <div class="code-block">
...
<span class="fn">ADDCOLUMNS</span>(
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>من القائمة العلوية اختار العمود Date وضغط Mark as Date Table. Power BI سيتحقق أن التواريخ مستمرة وفريدة.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>Sort Month Name:</strong> عمود Month Name يرتب أبجدياً (أبريل قبل يناير!). لأن تصلح ده، في الـ Data View اختار عمود Month Name ثم Column Tools → Sort by Column → اختار Month Num.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="warn-box">
      <div class="icon">🚨</div>
      <p><strong>Rule to know:</strong> Power BI won't accept Time Intelligence functions (TOTALYTD, SAMEPERIODLASTYEAR…) unless you have a continuous calendar table with no date gaps, marked as the Date Table.</p>
    </div>
    <div class="lesson-card">
      <h3>Method 1 — CALENDARAUTO() (quickest)</h3>
      <p>Automatically generates a calendar from the earliest date to the latest across the entire model. Use it when your data has no gaps:</p>
      <div class="code-block">
        <span class="cm">-- Automatic calendar table</span>
Date_Table = 
<span class="fn">ADDCOLUMNS</span>(
    <span class="fn">CALENDARAUTO</span>(),
    <span class="str">"Year"</span>,        <span class="fn">YEAR</span>([Date]),
    ...
    <div class="lesson-card">
      <h3>Method 2 — CALENDAR() (full control)</h3>
      <p>You define the exact date range yourself. Useful when your data includes future or historical dates outside what CALENDARAUTO would detect:</p>
      <div class="code-block">
        <span class="cm">-- Calendar from 2020 to the end of the current year</span>
Date_Table = 
<span class="fn">ADDCOLUMNS</span>(
    <span class="fn">CALENDAR</span>(
        <span class="fn">DATE</span>(<span class="num">2020</span>, <span class="num">1</span>, <span class="num">1</span>),
    ...
    <span class="str">"Year"</span>,           <span class="fn">YEAR</span>([Date]),
    <span class="str">"Month Num"</span>,      <span class="fn">MONTH</span>([Date]),
    <span class="str">"Month Name"</span>,     <span class="fn">SWITCH</span>(<span class="fn">MONTH</span>([Date]),
    ...
    <div class="lesson-card">
      <h3>Activating the calendar (Mark as Date Table)</h3>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Go to Model View</h4>
            <p>Open the Relationships screen and select the Date_Table table.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Table Tools → Mark as Date Table</h4>
            <p>From the top menu, select the Date column and click Mark as Date Table. Power BI will verify that all dates are continuous and unique with no gaps.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Create the relationship</h4>
            <p>In Model View, drag Date_Table[Date] onto the date column in your Fact table (e.g. Sales[OrderDate]). It should be a One-to-Many relationship with the calendar on the One side.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="tip-box">
      <div class="icon">✅</div>
      <p><strong>Good practice:</strong> Always build the calendar table before writing any Time Intelligence measure. Many DAX errors trace back to a missing or incorrectly marked date table.</p>
    </div>` }],
  },
  "hierarchies": {
    ...
    en_lede: "Let users drill from year → quarter → month → day with a single click using hierarchies.",
    ...
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>What is a Hierarchy and why does it matter?</h3>
      <p>A hierarchy is a layered arrangement of connected data levels — the feature that powers <strong>Drill Down</strong>, which lets users move from a high-level summary down to granular detail with a single click.</p>
      <ul>
        <li>Time: Year → Quarter → Month → Day</li>
        <li>Geography: Country → Region → City → Branch</li>
        <li>Product: Category → Subcategory → Product</li>
      </ul>
    </div>
    <div class="lesson-card">
      <h3>Building a Hierarchy in Power BI Desktop</h3>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Pick the top-level column</h4>
            <p>In the Data pane, right-click the top column (e.g. <strong>Year</strong>) and select <strong>Create Hierarchy</strong>.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Add the remaining levels</h4>
            <p>Drag Quarter, Month, and Day onto the new Hierarchy, or right-click each one and choose <strong>Add to Hierarchy</strong>.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Order the levels</h4>
            <p>Drag levels into the right order — most general at the top, most detailed at the bottom.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">4</div>
          <div class="step-content">
            <h4>Use in a report</h4>
            <p>Drag the Hierarchy (not individual columns) onto a visual's Axis — Drill Down and Drill Up arrows appear automatically.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="lesson-card">
      <h3>Drill Down controls</h3>
      <table class="compare-table">
        <tr>
          <th>Button</th>
          <th>What it does</th>
        ...
        <tr>
          <td>↓ (single arrow)</td>
          <td>Enable drill mode — click a bar or point to go one level deeper.</td>
        </tr>
        <tr>
          <td>↓↓ (double arrow)</td>
          <td>Expand all — drill every item one level at once.</td>
        </tr>
        <tr>
          <td>↑ (up arrow)</td>
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>Tip:</strong> When you add a date column to a visual, Power BI creates a default date hierarchy automatically. You can rename or delete levels you don't need directly in the Data pane.</p>
    </div>` }],
  },
  "dax1": {
    ...
    en_lede: "DAX is the formula language that powers everything in Power BI. Here's how it works and where it lives.",
    sectionId: "dax1",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
    ...
    <table class="compare-table">
      ...
      <tr>
        ...
        <td>معادلة وهمية لا تأخذ مساحة، تُحسب فقط عند وضعها في مخطط.</td>
      </tr>
      <tr>
...
<td>A virtual formula that takes no storage space; it's evaluated only when you place it in a visual.</td>
</tr>
<tr>
...
<li><strong>Performance:</strong> Calculated Columns are computed at load time and consume RAM. Measures are computed on demand. Choose the right approach based on data size and complexity.</li>
  ...
  "filter-context": {
    eyebrow: "04 · 02 — Row Context و Filter Context",
    title: "Row Context و Filter Context",
    lede: "قبل أن تتعلم CALCULATE يجب أن تفهم السياق — لماذا نفس الصيغة تعطي نتائج مختلفة حسب مكان كتابتها.",
    en_eyebrow: "04 · 02 — Row Context & Filter Context",
    en_lede: "Before CALCULATE makes sense, you need to understand evaluation context — why the same formula gives different results depending on where you write it.",
    sectionId: "filter-context",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>ما هو الـ Evaluation Context؟</h3>
      <p>كل حساب في DAX يعمل داخل <strong>سياق تقييم (Evaluation Context)</strong> — وهو ببساطة "البيئة" التي يرى فيها الحساب البيانات. هناك نوعان أساسيان من السياق:</p>
      <ul>
        <li><strong>Row Context (سياق الصف):</strong> يعمل صفًّا بصف، ويرى صفًّا واحدًا في كل مرة.</li>
        <li><strong>Filter Context (سياق الفلترة):</strong> يرى مجموعة من الصفوف بعد تطبيق الفلاتر من الصفحة أو الـ Visual أو الـ Slicer.</li>
      </ul>
      <div class="warn-box">
        <div class="icon">⚠️</div>
        <p>الخلط بين النوعين هو السبب الأول لأخطاء DAX لدى المتعلمين. افهم هذا الدرس جيدًا قبل الانتقال لـ CALCULATE.</p>
      </div>
    </div>

    <div class="lesson-card">
      <h3>Row Context — سياق الصف</h3>
      <p>ينشأ Row Context تلقائيًا في حالتين:</p>
      <ul>
        <li><strong>Calculated Column:</strong> عند كتابة عمود محسوب، يعمل DAX صفًّا بصف ويرى قيمة كل صف.</li>
        <li><strong>Iterator Functions (SUMX، AVERAGEX...):</strong> كل دالة Iterator تنشئ Row Context مؤقتًا لكل صف.</li>
      </ul>
      <div class="code-block">
        <span class="cm">-- Calculated Column: DAX يرى صفًّا واحدًا في كل مرة</span>
        <span class="cm">-- Sales[Qty] وSales[UnitPrice] هي قيم الصف الحالي</span>
Revenue = Sales[Qty] * Sales[UnitPrice]

        <span class="cm">-- SUMX: ينشئ Row Context لكل صف ثم يجمع النتائج</span>
Total Revenue = <span class="fn">SUMX</span>(Sales, Sales[Qty] * Sales[UnitPrice])
      </div>
      <p><strong>القيد الجوهري:</strong> داخل Row Context لا يمكنك استدعاء مقياس (Measure) مباشرةً. المقاييس تحتاج Filter Context وليس Row Context.</p>
    </div>

    <div class="lesson-card">
      <h3>Filter Context — سياق الفلترة</h3>
      <p>ينشأ Filter Context من:</p>
      <ul>
        <li><strong>الـ Visual أو الجدول:</strong> عندما تضع Measure في جدول يحتوي على عمود Year، الـ Measure يرى بيانات تلك السنة فقط.</li>
        <li><strong>الـ Slicer:</strong> فلتر المستخدم يحدد ما يراه الـ Measure.</li>
        <li><strong>الـ CALCULATE:</strong> يمكنك تعديل Filter Context يدويًا (الدرس القادم).</li>
      </ul>
      <div class="code-block">
        <span class="cm">-- هذا Measure بسيط</span>
Total Sales = <span class="fn">SUM</span>(Sales[Amount])

        <span class="cm">-- في Visual يحتوي على عمود Year:</span>
        <span class="cm">-- 2022 → Total Sales = مجموع مبيعات 2022 فقط</span>
        <span class="cm">-- 2023 → Total Sales = مجموع مبيعات 2023 فقط</span>
        <span class="cm">-- Power BI يغير الـ Filter Context تلقائيًا لكل صف في الجدول</span>
      </div>
    </div>

    <div class="lesson-card">
      <h3>الفرق العملي — نفس الصيغة، نتيجتان مختلفتان</h3>
      <table class="compare-table">
        <tr>
          <th>Calculated Column</th>
          <th>Measure</th>
        ...
        <tr>
          <td>يعمل في Row Context</td>
          <td>يعمل في Filter Context</td>
        </tr>
        <tr>
          <td>يُحسب مرة واحدة عند التحديث ويُخزَّن</td>
          <td>يُحسب في كل مرة يُعرض فيها</td>
        </tr>
        <tr>
          <td>يمكنه قراءة أعمدة الصف الحالي مباشرةً</td>
          <td>لا يرى "صفًّا بعينه" — يرى مجموعة مفلترة</td>
        </tr>
        <tr>
          <td>ثقيل على الذاكرة — تجنّب إنشاءه بدون سبب</td>
          <td>ديناميكي — الأفضل في معظم الحالات</td>
        </tr>
      </table>
    </div>

    <div class="lesson-card">
      <h3>Context Transition — التحويل بين السياقين</h3>
      <p>هنا يكمن سرّ CALCULATE: عند استدعاء Measure داخل Row Context (مثل داخل SUMX)، يحدث <strong>Context Transition</strong> — يتحول Row Context إلى Filter Context مطابق للصف الحالي.</p>
      <div class="code-block">
        <span class="cm">-- مثال: حساب مساهمة كل منتج كنسبة من الإجمالي</span>
Product % =
<span class="fn">DIVIDE</span>(
    [Total Sales],                              <span class="cm">-- Filter Context: بيانات المنتج الحالي</span>
    <span class="fn">CALCULATE</span>([Total Sales], <span class="fn">ALL</span>(Products))  <span class="cm">-- Filter Context معدَّل: كل المنتجات</span>
)

        <span class="cm">-- بدون CALCULATE لا يمكنك تغيير ما "يراه" الـ Measure</span>
      </div>
    </div>

    <div class="tip-box">
      <div class="icon">✅</div>
      <p><strong>القاعدة الذهبية:</strong> إذا أردت حساباً يتغير بناءً على موقعه في التقرير → <strong>Measure</strong>. إذا أردت قيمة ثابتة مرتبطة بكل صف من البيانات → <strong>Calculated Column</strong>. 99% من الأخطاء تختفي عند تطبيق هذه القاعدة.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>What is Evaluation Context?</h3>
      <p>Every DAX calculation runs inside an <strong>evaluation context</strong> — the "environment" that determines which rows the calculation can see. There are two fundamental types:</p>
      <ul>
        <li><strong>Row Context:</strong> works row by row, seeing exactly one row at a time.</li>
        <li><strong>Filter Context:</strong> sees a filtered set of rows shaped by page filters, slicers, or visual axes.</li>
      </ul>
      <div class="warn-box">
        <div class="icon">⚠️</div>
        <p>Confusing these two contexts is the single biggest source of DAX errors. Understand this lesson thoroughly before moving on to CALCULATE.</p>
      </div>
    </div>

    <div class="lesson-card">
      <h3>Row Context</h3>
      <p>Row Context is created automatically in two situations:</p>
      <ul>
        <li><strong>Calculated Columns:</strong> DAX iterates through each row and evaluates the expression with that row's values in scope.</li>
        <li><strong>Iterator functions (SUMX, AVERAGEX…):</strong> each iterator creates a temporary Row Context for every row it visits.</li>
      </ul>
      <div class="code-block">
        <span class="cm">-- Calculated Column: DAX sees one row at a time</span>
        <span class="cm">-- Sales[Qty] and Sales[UnitPrice] are the current row's values</span>
Revenue = Sales[Qty] * Sales[UnitPrice]

        <span class="cm">-- SUMX: creates a Row Context for each row, then sums results</span>
Total Revenue = <span class="fn">SUMX</span>(Sales, Sales[Qty] * Sales[UnitPrice])
      </div>
      <p><strong>The key limitation:</strong> inside Row Context you can't call a Measure directly — Measures require Filter Context, not Row Context.</p>
    </div>

    <div class="lesson-card">
      <h3>Filter Context</h3>
      <p>Filter Context is established by:</p>
      <ul>
        <li><strong>Visuals and tables:</strong> when a Measure sits in a table that has a Year column, the Measure sees only that year's data.</li>
        <li><strong>Slicers:</strong> the user's selection narrows what the Measure sees.</li>
        <li><strong>CALCULATE:</strong> lets you modify the Filter Context programmatically (next lesson).</li>
      </ul>
      <div class="code-block">
        <span class="cm">-- A simple measure</span>
Total Sales = <span class="fn">SUM</span>(Sales[Amount])

        <span class="cm">-- In a visual with a Year axis:</span>
        <span class="cm">-- 2022 row → Total Sales = sum of 2022 sales only</span>
        <span class="cm">-- 2023 row → Total Sales = sum of 2023 sales only</span>
        <span class="cm">-- Power BI adjusts the Filter Context automatically for each row</span>
      </div>
    </div>

    <div class="lesson-card">
      <h3>The practical difference — same formula, two outcomes</h3>
      <table class="compare-table">
        <tr>
          <th>Calculated Column</th>
          <th>Measure</th>
        ...
        <tr>
          <td>Runs in Row Context</td>
          <td>Runs in Filter Context</td>
        </tr>
        <tr>
          <td>Calculated once at refresh and stored</td>
          <td>Calculated fresh every time it renders</td>
        </tr>
        <tr>
          <td>Can read current row columns directly</td>
          <td>Doesn't "see" individual rows — sees a filtered set</td>
        </tr>
        <tr>
          <td>Heavy on memory — avoid creating without good reason</td>
          <td>Dynamic — the right choice for most calculations</td>
        </tr>
      </table>
    </div>

    <div class="lesson-card">
      <h3>Context Transition — CALCULATE's secret</h3>
      <p>Here's what makes CALCULATE special: when you call a Measure inside a Row Context (e.g. inside SUMX), <strong>Context Transition</strong> occurs — the Row Context is converted into an equivalent Filter Context that matches exactly the current row.</p>
      <div class="code-block">
        <span class="cm">-- Each product's share of total sales</span>
Product % =
<span class="fn">DIVIDE</span>(
    [Total Sales],                              <span class="cm">-- Filter Context: current product's data</span>
    <span class="fn">CALCULATE</span>([Total Sales], <span class="fn">ALL</span>(Products))  <span class="cm">-- Modified context: all products</span>
)

        <span class="cm">-- Without CALCULATE you can't change what the Measure "sees"</span>
      </div>
    </div>

    <div class="tip-box">
      <div class="icon">✅</div>
      <p><strong>Golden rule:</strong> if you need a value that changes based on its position in the report → <strong>Measure</strong>. If you need a fixed value attached to every row in the data → <strong>Calculated Column</strong>. Ninety-nine percent of context errors disappear when you apply this rule consistently.</p>
    </div>` }],
  },
  "dax-logical": {
...
<span class="fn">IF</span>(
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>IFERROR و ISBLANK:</strong> إذا الـ Measure ممكن يرجع خطأ (مثل قسمة) استخدم <code>IFERROR([Measure], 0)</code>. إذا ممكن يرجع BLANK استخدم <code>IF(ISBLANK([Measure]), "لا يوجد", [Measure])</code>.</p>
    </div>
...
<div class="warn-box">
<div class="icon">⚠️</div>
<p><strong>IF Overlapping = problem:</strong> The higher the levels, the more difficult it's to read and edit. More than two levels → Go to SWITCH(TRUE()) immediately.</p>
</div>
<div class="lesson-card">
...
<li><strong>Test for NULL values:</strong> Use ISBLANK before comparisons if values could be empty.</li>
  ...
  "calculate": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <p>CALCULATE تقوم بشيئين في نفس الوقت: تحسب المعادلة الأولى، ثم تعدّل الـ Filter Context بناءً على الفلاتر التي حددتها. الترتيب مهم:</p>
      <div class="code-block">
...
<span class="fn">CALCULATE</span>(
    ...
    <div class="lesson-card">
      ...
      <p>الثلاثة يمسحون الفلاتر، لكن بطرق مختلفة:</p>
      <div class="code-block">
...
<span class="fn">DIVIDE</span>(
    ...
    <div class="lesson-card">
      ...
      <p>عادةً CALCULATE يستبدل الفلتر الموجود. KEEPFILTERS يضيف الفلتر الجديد على الموجود (تقاطع):</p>
      <div class="code-block">
<span class="cm">-- بدون KEEPFILTERS: يعرض مبيعات الشمال حتى وإن الـ Slicer على الجنوب</span>
North Only = <span class="fn">CALCULATE</span>([Total Sales], Dim_Region[Region] = <span class="str">"North"</span>)

<span class="cm">-- مع KEEPFILTERS: إذا الـ Slicer على الجنوب → النتيجة BLANK</span>
North Filtered = 
<span class="fn">CALCULATE</span>(
    [Total Sales],
    ...
    <div class="lesson-card">
      ...
      <p>لما تستخدم CALCULATE جوه Calculated Column، الـ Row Context يتحوّل تلقائياً لـ Filter Context. هذا مهم جداً ويُسبّب confusion:</p>
      <div class="code-block">
<span class="cm">-- هذا العمود: لكل صف يحسب نسبة المبيعات من إجمالي نفس الفئة</span>
<span class="cm">-- CALCULATE هنا تعمل Context Transition: Row → Filter</span>
Sales % of Category = 
<span class="fn">DIVIDE</span>(
    Fact_Sales[Amount],
    <span class="fn">CALCULATE</span>(
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>ALLEXCEPT توفر الكود:</strong> بدل تكتب ALL ولاحقاً تضيف الفلتر، استخدم ALLEXCEPT مباشرة — أقصر وأوضح.</li>
...
<div class="lesson-card">
<h3>ALL vs REMOVEFILTERS vs ALLEXCEPT</h3>
<p>All three clear filters, but each works differently:</p>
<div class="code-block">
...
<span class="cm">-- REMOVEFILTERS: same as ALL but clearer in intent — preferred</span>
% of Total = 
<span class="fn">DIVIDE</span>(
    [Total Sales],
    <span class="fn">CALCULATE</span>([Total Sales], <span class="fn">REMOVEFILTERS</span>(Dim_Product)),
...
<span class="cm">-- الآن يمكنك استخدامه في Calculated Column آخر</span>
Is Electronics = 
<span class="fn">IF</span>(
...
Products Sold = <span class="fn">COUNTROWS</span>(<span class="fn">RELATEDTABLE</span>(Dim_Product))
    ...
    <div class="lesson-card">
      ...
      <p>مشكلة شائعة: جدول الـ Fact فيه تاريخين (OrderDate و DeliveryDate) لكن النموذج يسمح بعلاقة نشطة واحدة فقط مع Date Table. الحل: اعمل العلاقتين وفعّل التي تحتاجه بـ USERELATIONSHIP:</p>
      <div class="code-block">
<span class="cm">-- الإعداد في النموذج:</span>
...
<span class="fn">CALCULATE</span>(
    ...
    <div class="lesson-card">
      ...
      <p>بدل تغيير العلاقة للـ Both في النموذج (وما يسببه من بطء)، استخدم CROSSFILTER داخل Measure فقط عند الحاجة:</p>
      <div class="code-block">
<span class="cm">-- مشكلة: عدد العملاء الذين لم يشتروا بعد</span>
<span class="cm">-- في النموذج العادي (Single direction) Dim_Customer لا تُفلتر من Fact_Sales</span>
...
<span class="fn">CALCULATE</span>(
    ...
    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>CROSSFILTER في Measure = آمن. Both في النموذج = خطر:</strong> CROSSFILTER يفعّل الفلترة الثنائية فقط لحظة تنفيذ الـ Measure المحدد. أما تغيير العلاقة لـ Both في النموذج، فيؤثر على كل المعادلات في التقرير ويسبب نتائج غير متوقعة في أماكن أخرى.</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>USERELATIONSHIP أفضل من تغيير النموذج:</strong> إذا كنت بحاجة تفعيل علاقة غير نشطة، استخدم USERELATIONSHIP في الـ Measure بدل تغيير العلاقة لـ Both في النموذج (ده بيبطّء الأداء).</li>
        <li><strong>CROSSFILTER فقط عند الحاجة:</strong> استخدمها فقط في الـ Measures المحددة، ليس في كل النموذج. فعّل الفلترة الثنائية بحذر.</li>
        <li><strong>اختبر التفاعلات بين العلاقات:</strong> إذا النموذج فيه علاقات متشابكة، جرّب كل الـ Slicers والـ Cross-filters للتأكد من النتائج.</li>
        <li><strong>توثيق العلاقات المعقدة:</strong> إذا استخدمت USERELATIONSHIP أو CROSSFILTER، اترك ملاحظة في الـ Measure توضح ليه استخدمت ده.</li>
      </ul>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
...
<div class="code-block">
<span class="cm">-- Problem: Number of customers who haven't yet purchased</span>
<span class="cm">-- In the regular model (Single direction) Dim_Customer isn't filtered by Fact_Sales</span>
...
<h3>🏆 Pro Tips from field experience</h3>
<ul>
<li><strong>RELATED in Calculated Columns only:</strong> in Measures use RELATEDTABLE. RELATED doesn't work in Measures and you'll get an error.</li>
...
<li><strong>Document complex relationships:</strong> If you use USERELATIONSHIP or CROSSFILTER, leave a note in the Measure explaining why you used it.</li>
  ...
  "iterators": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <div class="code-block">
<span class="cm">-- SUM: تجمع عمود Amount الموجود في الجدول</span>
Total Sales = <span class="fn">SUM</span>(Fact_Sales[Amount])

<span class="cm">-- SUMX: يُضرب السعر في الكمية صف بصف ثم تجمع</span>
<span class="cm">-- مفيد إذا لم يكن هناك عمود Amount ولديك Qty و Price فقط</span>
...
<span class="fn">SUMX</span>(
    ...
    <div class="lesson-card">
      ...
      <div class="code-block">
<span class="cm">-- متوسط قيمة الفاتورة (وليس متوسط العمود — يحسب لكل فاتورة ثم يجمع)</span>
Avg Order Value = 
...
<span class="fn">PRODUCTX</span>(
    ...
    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>Iterator داخل Iterator = بطء شديد:</strong> تجنب وضع SUMX جوّا SUMX جوّا SUMX. النموذج سيتباطأ بشكل أسّي. إذا كنت بحاجةها، استخدم Calculated Column أولاً لتخزين الحساب الداخلي.</p>
    </div>

    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>قاعدة الاختيار:</strong> إذا الحساب يحتاج ضرب أو قسمة أو منطق على مستوى الصف → SUMX. إذا تجمع عمود موجود فقط → SUM (أسرع).</p>
    </div>

    <div class="lesson-card">
      <h3>🏆 Pro Tips من الخبرة الميدانية</h3>
      <ul>
        <li><strong>SUM أسرع من SUMX:</strong> إذا تقدر تستخدم SUM (العمود موجود فعلاً)، استخدمها. SUMX بطيء لأنها تمشي صف بصف.</li>
        <li><strong>SUMX مع FILTER = بطء شديد:</strong> تجنب تكرار SUMX جوّا SUMX. إذا كنت بحاجة، استخدم Calculated Column أولاً.</li>
...
<p>SUM aggregates an existing column directly. SUMX evaluates an expression row by row and then combines the results:</p>
<div class="code-block">
<span class="cm">-- SUM: aggregates the Amount column directly</span>
Total Sales = <span class="fn">SUM</span>(Fact_Sales[Amount])

<span class="cm">-- SUMX: multiply price × quantity for each row, then sum the results</span>
<span class="cm">-- Useful if there's no Amount column and you only have Qty and Price</span>
Total Revenue = <span class="fn">SUMX</span>(Fact_Sales, Fact_Sales[Qty] * Fact_Sales[UnitPrice])
...
<h3>AVERAGEX, MAXX, MINX, COUNTX</h3>
<div class="code-block">
<span class="cm">-- Average order value — calculates each order's total first, then averages them</span>
Avg Order Value = 
<span class="fn">AVERAGEX</span>(
    <span class="fn">VALUES</span>(Fact_Sales[OrderID]),
    <span class="fn">CALCULATE</span>(<span class="fn">SUM</span>(Fact_Sales[Amount]))
...
<span class="cm">-- Count of orders with more than 3 line items</span>
Orders Above 3 Lines = 
<span class="fn">COUNTX</span>(
    <span class="fn">FILTER</span>(
        <span class="fn">VALUES</span>(Fact_Sales[OrderID]),
...
<span class="fn">DIVIDE</span>(
    ...
    <div class="lesson-card">
      ...
      <div class="code-block">
<span class="cm">-- مبيعات الشهر التي فات</span>
Sales Last Month =
<span class="fn">CALCULATE</span>(
    [Total Sales],
...
Sales MTD = <span class="fn">TOTALMTD</span>([Total Sales], 'Calendar'[Date])
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>DATEADD يحتفظ بالنافذة الحالية:</strong> إذا الـ Slicer على Q1، DATEADD(-1, QUARTER) يعطيك Q4 من السنة السابقة، لكن يحافظ على القيود الأخرى.</li>
        <li><strong>اختبر السنوات الكبيسة:</strong> إذا بيانات تتضمن سنوات كبيسة (29 فبراير)، تأكد من نتائج المقارنات الزمنية.</li>
      </ul>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="warn-box">
<div class="icon">🚨</div>
...
<span class="cm">-- إذا أنت في مارس 2025 → يرجع مارس 2024 فقط</span>
Sales DATEADD LY = 
...
<span class="cm">-- إذا الـ Slicer على Q1 2025 → يرجع Q1 2024 كامل</span>
Sales Parallel LY = 
<span class="fn">CALCULATE</span>(
    [Total Sales],
...
<span class="kw">RETURN</span>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>PARALLELPERIOD للمقارنات الكاملة:</strong> إذا كنت بحاجة تقارن فترة كاملة (ربع كامل) بنفس الفترة من الماضي، PARALLELPERIOD أحسن خيار.</li>
...
<span class="cm">-- If you're in March 2025 → it will only be March 2024</span>
Sales DATEADD LY = 
<span class="fn">CALCULATE</span>([Total Sales], <span class="fn">DATEADD</span>('Date'[Date], <span class="num">-12</span>, MONTH))
...
<li><strong>Performance: Test with real data:</strong> Moving Average and DATESINPERIOD can be slow with millions of rows. Test them with production data before release.</li>
  ...
  "fieldparams": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <p>Field Parameter هو جدول خاص يحتوي على قائمة من الـ Measures أو الأعمدة. لما تضعه كـ Slicer، المستخدم يختار أي Measure يريد رؤيته في المخطط في نفس اللحظة.</p>
    </div>
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>مثلاً: Total Sales، Total Profit، Total Qty. Power BI هيسمّيه Parameter1 وستستطيع تغيّر الاسم.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            ...
            <p>ستجد جدول جديد في النموذج وفيه 3 أعمدة: Fields (الاسم)، Order (الترتيب)، وعمود بنفس اسم الـ Parameter.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">4</div>
          <div class="step-content">
            <h4>استخدمه في المخطط والـ Slicer</h4>
            <p>ضع عمود Parameter في محور Y للمخطط. وضع عمود Fields في Slicer. المستخدم يختار وتتغير البيانات فوراً.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="step-num">2</div>
<div class="step-content">
<h4>Add the measures you want to switch between</h4>
<p>For example: Total Sales, Total Profit, Total Qty. Power BI names it Parameter1 by default — you can rename it right away.</p>
</div>
</div>
<div class="step">
<div class="step-num">3</div>
...
<p><strong>Professional use:</strong> Combining Dimension Parameter + Measure Parameter on the same page gives the user complete control over the report — choosing what to display and at what level — without any additional pages.</p>
  ...
  "dax3": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <p>بدل ما تكتب نفس الحساب أكثر من مرة، خزّنه في متغير. أسرع في التنفيذ وأسهل في القراءة والصيانة.</p>
      <div class="code-block">
...
<span class="cm">-- عدد العملاء التي اشتروا أكثر من مرة</span>
Repeat Customers = 
<span class="fn">COUNTROWS</span>(
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>قاعدة ذهبية:</strong> دايماً استخدم <strong>VAR</strong> إذا نفس الحساب يتكرر أكثر من مرة في نفس الـ Measure. أسرع وأوضح.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
...
<div class="tip-box">
<div class="icon">💡</div>
<p><strong>FORMAT Returns text — Do not use it in calculations:</strong> after FORMAT You can't add or subtract the result. Use it only in the Card or Tooltip or Labels. For calculations stay with the original numbers.</p>
</div>` }],
  },
  "dax-m2m": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <p>في نماذج البيانات العادية، العلاقة تكون <strong>One-to-Many</strong> — منتج واحد له كثير من المبيعات. المشكلة تظهر في <strong>Many-to-Many (M2M)</strong>: موظف اشتغل في أكثر من فرع، وكل فرع فيه أكثر من موظف.</p>
      <p>النتيجة: مبيعات الموظف المشترك ستُحسب <strong>مرتين</strong> في كل فرع — وهذا ما نسميه Double Counting.</p>
    </div>

    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>الحل الغلط — Both Filter Direction:</strong> تحويل العلاقة لـ "Both" في النموذج يبدو سهلاً لكنه خطير. يُسبّب <strong>ambiguous filter paths</strong> — الفلاتر تسلك مسارات غير متوقعة، الأرقام تتكرر، والأداء يتراجع.</p>
    </div>
...
<span class="cm">-- العلاقات في النموذج (اتجاه واحد فقط):</span>
Dim_Employee  ---1:M--&gt; Bridge_EmpBranch &lt;--M:1--- Dim_Branch
Dim_Employee  ---1:M--&gt; Fact_Sales
      </div>
      <div class="tip-box">
        <div class="icon">💡</div>
        <p><strong>Bridge Table = الحل الأفضل دائماً.</strong> الفلاتر تمشي في اتجاه واحد واضح بدون ambiguity. لا تحتاج DAX خاص في كل Measure — النموذج يحل المشكلة تلقائياً.</p>
      </div>
    </div>

    <div class="lesson-card">
      <h3>TREATAS — العلاقة الوهمية في DAX</h3>
      <p>لو ليس قادر تعدّل النموذج (Data Source ثابت أو أذونات محدودة)، <strong>TREATAS</strong> تبني علاقة وهمية (Virtual Relationship) جوا الـ Measure نفسه بس.</p>
      <div class="code-block">
...
<span class="fn">CALCULATE</span>(
    ...
    <div class="lesson-card">
      <h3>مثال واقعي: منتجات في أكثر من فئة</h3>
...
<span class="fn">CALCULATE</span>(
    ...
    <div class="lesson-card">
      ...
      <p>SUMMARIZE تبني جدول وهمي مجمّع — مفيدة كمدخل لـ TOPN وFILTER وCOUNTROWS:</p>
      <div class="code-block">
...
<span class="fn">CALCULATE</span>([Total Sales], <span class="fn">TREATAS</span>(Top3, Dim_Category[CategoryName]))
      ...
      <div class="tip-box">
        <div class="icon">💡</div>
        <p><strong>SUMMARIZE + TREATAS = combo قوي</strong> لعمل فلاتر ديناميكية معقدة جوا الـ Measures من غير ما تحتاج تغيير النموذج.</p>
      </div>
    </div>
    ...
    <div class="lesson-card">
      <h3>🏆 Pro Tips</h3>
      <ul>
        <li><strong>Bridge أولاً، TREATAS ثانياً:</strong> Bridge Table في النموذج هي الحل المعماري الصح. TREATAS هو خيار آخر إذا النموذج ليس في إيدك.</li>
        <li><strong>نفس نوع البيانات ضروري:</strong> TREATAS تحتاج عمود المصدر وعمود الهدف بنفس الـ Data Type — رقم مع رقم، نص مع نص.</li>
        <li><strong>اختبر بـ COUNTROWS أولاً:</strong> COUNTROWS(TREATAS(...)) تساعدك تتأكد إن الجدول الوهمي يُرجع الصفوف الصح قبل أن تضيف الحسابات.</li>
        <li><strong>TREATAS تؤثر على Filter Context بس:</strong> ليس علاقة فعلية في النموذج. تؤثر فقط داخل الـ Measure الذي استخدمتها فيه.</li>
        <li><strong>CROSSFILTER(BOTH) ليس حل:</strong> له نفس مشاكل Both في النموذج. TREATAS أنظف وأوضح وأأمن.</li>
      </ul>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
...
<div class="warn-box">
<div class="icon">⚠️</div>
<p><strong>Wrong solution — Both Filter Direction:</strong> Switching the relationship to "Both" looks easy but it's dangerous. It causes <strong>ambiguous filter paths</strong> — filters take unexpected routes, numbers get double-counted, and performance degrades noticeably.</p>
</div>
<div class="lesson-card">
...
<p>If you can't change the model (fixed data source, limited permissions), <strong>TREATAS</strong> builds a virtual relationship inside the measure itself only.</p>
<div class="code-block">
<span class="cm">-- Basic syntax</span>
<span class="fn">TREATAS</span>(table_expression, column1 [, column2 ...])
...
<li><strong>TREATAS only affects Filter Context:</strong> It doesn't create a real model relationship. The effect is only inside the measure where you used it.</li>
<li><strong>CROSSFILTER(BOTH) isn't a solution:</strong> It has the same problems as Both in the model. TREATAS is cleaner, clearer, and safer.</li>
</ul>
</div>` }],
  },
  "dax-budget": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <p>إذا ربطت الجدولين مباشرة وطرحت Budget من Actuals ستأخذ أرقام غلط لأن الـ granularity مختلف.</p>
    </div>

    <div class="lesson-card">
      <h3>تصميم النموذج الصح</h3>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
...
<span class="cm">-- Variance % = 0  → رمادي  (مكتمل بالضبط)</span>
<span class="cm">-- Variance % &lt; 0  → أحمر   (أقل من الهدف)</span>
    ...
    <div class="lesson-card">
      <h3>🏆 Pro Tips</h3>
      <ul>
        <li><strong>YearMonth كـ Integer:</strong> خزّن YearMonth كـ 202401 ليس "2024-01". الأرقام أسرع في الفلترة والمقارنة.</li>
        <li><strong>DIVIDE دايماً بدل /:</strong> في Variance % وAchievement %، استخدم DIVIDE لتجنب خطأ القسمة على صفر عند بداية السنة.</li>
        <li><strong>Budget الشهري قبل الإدراج:</strong> إذا الميزانية سنوية أو ربعية، قسّمها في Power Query قبل أن تدخل النموذج — أسهل وأدق.</li>
        <li><strong>اختبر بـ Matrix Visual:</strong> افرد الشهور على Rows وشوف Budget وActuals جنب بعض. إذا الأرقام بدت غريبة، في مشكلة في TREATAS.</li>
        <li><strong>Budget Remaining:</strong> فكّر تضيف [Budget Remaining] = [Budget YTD] - [Actuals YTD] لأن Stakeholders يعرفوا المتبقي.</li>
      </ul>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
...
<p>If you link both tables directly and subtract Budget from Actuals you'll get wrong numbers because their granularity differs.</p>
</div>
<div class="lesson-card">
...
<p>Fact_Budget doesn't link directly to the Date Table. Build a YearMonth column in the Date Table and use TREATAS in measures to apply the correct filter.</p>
</div>
</div>
</div>
</div>
...
<li><strong>Add Budget Remaining:</strong> [Budget Remaining] = [Budget YTD] - [Actuals YTD] helps stakeholders track how much budget is left.</li>
  ...
  "dax-performance": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>كيف DAX يعمل من الداخل؟</h3>
      <p>لتحسين الأداء، يجب تعرف إن DAX يعمل عبر <strong>محركين</strong>:</p>
      <table class="compare-table">
        <tr>
        ...
        <tr>
          <td>أسرع بكثير — استخدمه قدر الإمكان</td>
...
<span class="cm">-- ✅ أسرع: Column Predicate → Storage Engine يعمل الفلتر</span>
Fast Sales =
<span class="fn">CALCULATE</span>(
    <span class="fn">SUM</span>(Fact_Sales[Amount]),
...
<span class="fn">CALCULATE</span>(
    ...
    <div class="lesson-card">
      ...
      <p>DAX يحسب كل VAR <strong>مرة واحدة فقط</strong> — ليس كل مرة تظهر في التعبير:</p>
      <div class="code-block">
...
<span class="fn">IF</span>(Pct > <span class="num">0.1</span>, Pct * <span class="num">100</span>, Pct)
    ...
    <div class="lesson-card">
      ...
      <div class="code-block">
<span class="cm">-- ❌ خطر: إذا المقام صفر → خطأ في الـ Visual</span>
...
Clean Margin = <span class="fn">DIVIDE</span>([Total Profit], [Total Sales], <span class="fn">BLANK</span>())
      ...
      <div class="tip-box">
        <div class="icon">💡</div>
        <p>DIVIDE مع BLANK() أفضل في الـ KPI Cards لأنه يحافظ على نظافة الـ Visual عند البيانات الناقصة أو أول الأشهر.</p>
      </div>
    </div>

    <div class="lesson-card">
      <h3>Performance Analyzer — شوف المشكلة قبل أن تحلها</h3>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>اضغط على Slicers أو غيّر الصفحات. كل Visual سيسجّل وقت تنفيذه.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
    ...
    <div class="lesson-card">
      <h3>الأنماط المشهورة التي تُبطئ DAX</h3>
      <div class="code-block">
...
Fast       = <span class="fn">SUM</span>(Fact_Sales[LineAmount])           <span class="cm">-- ثم SUM</span>
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>Column Predicate > FILTER دايماً:</strong> CALCULATE([M], Table[Col] = "X") أسرع لأنه يشتغل بـ Storage Engine ليس Formula Engine.</li>
        <li><strong>FILTER على Dimension ليس Fact:</strong> إذا كنت بحاجة FILTER، فلتر على Dim_Product (آلاف الصفوف) ليس Fact_Sales (ملايين الصفوف).</li>
        <li><strong>VALUES أسرع من FILTER(ALL(...)):</strong> استخدم VALUES(Table[Col]) بدل FILTER(ALL(Table), ...) للحصول على قيم فريدة.</li>
        <li><strong>قيّم الأداء قبل أن تحسّن:</strong> استخدم Performance Analyzer لتحديد Visual البطيء أولاً. لاحقاً حسّن الـ Measure المسبّبة للبطء.</li>
        <li><strong>Calculated Column للعمليات الثابتة:</strong> إذا الحساب ثابت وليس يتغيّر بالفلاتر (مثل Qty × Price)، خليه Calculated Column بدل SUMX.</li>
      </ul>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
  ...
  "dax-reference": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <table class="compare-table">
        ...
        <tr><td><strong>SUM</strong></td><td>مجموع عمود</td><td>الأسرع — استخدمها دائماً إذا العمود موجود</td></tr>
...
<tr><td><strong>COUNT / COUNTA</strong></td><td>Count numbers/texts</td><td>COUNTA Counts everything that isn't empty</td></tr>
...
<p><strong>The fastest way to learn DAX:</strong> When faced with a new problem, go to dax.guide — The official website for documenting functions DAX With examples and difficulty level. Every function mentioned here is included with a detailed explanation and application example.</p>
  ...
  "composite-models": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>ما هو الـ Composite Model؟</h3>
      <p>الـ Composite Model يتيح لك <strong>دمج Import وDirectQuery في نفس النموذج</strong>. بعض الجداول تُحمَّل في الذاكرة (Import) وبعضها يُقرأ مباشرةً من المصدر (DirectQuery) — وكلها تعمل معًا في نفس التقرير.</p>
      <table class="compare-table">
        <tr>
          <th>المشكلة</th>
          <th>الحل</th>
        ...
        <tr>
          <td>الجدول الأساسي ضخم جدًا (مليار صف)</td>
          <td>DirectQuery على الـ Fact Table الكبير</td>
        </tr>
        <tr>
          <td>جداول الـ Dimensions صغيرة ومحتاجة بسرعة</td>
          <td>Import للـ Dimensions والـ Aggregations</td>
        </tr>
        <tr>
          <td>التقرير يحتاج Real-Time على بعض البيانات</td>
          <td>DirectQuery للبيانات الحية + Import للتاريخية</td>
        </tr>
      </table>
    </div>

    <div class="lesson-card">
      <h3>Aggregation Tables — السر الحقيقي</h3>
      <p>الـ Aggregation Table هو جدول ملخَّص مُحمَّل في الذاكرة (Import) يحتوي على بيانات مجمَّعة من الـ Fact Table الكبير. عندما يطلب المستخدم تحليلاً عالي المستوى، Power BI يقرأ من الـ Aggregation Table الصغير بدلاً من إرسال استعلام للـ Fact Table الضخم.</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>أنشئ جدول تجميع</h4>
            <p>في Power Query أو في قاعدة البيانات، أنشئ جدولاً يحتوي على بيانات مجمَّعة — مثلاً: مجموع المبيعات حسب اليوم والمنتج والمنطقة.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>اضبط Storage Mode = Import</h4>
            <p>في Model View، حدد جدول الـ Aggregation وغيّر Storage Mode إلى Import. الـ Fact Table الأصلي يبقى DirectQuery.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>إدارة التجميعات — Manage Aggregations</h4>
            <p>كليك يمين على جدول الـ Aggregation → Manage Aggregations. ربط كل عمود في الـ Aggregation بالعمود المقابل في الـ Fact Table مع تحديد عملية التجميع (Sum, GroupBy...).</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">4</div>
          <div class="step-content">
            <h4>اختبر الـ Aggregation Hit</h4>
            <p>في Performance Analyzer، ابحث عن "Aggregation Hit" في نتائج DAX Studio. إذا ظهرت، فـ Power BI يستخدم الـ Aggregation Table بدلاً من DirectQuery.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-card">
      <h3>متى تستخدم Composite Models؟</h3>
      <ul>
        <li><strong>بيانات تجاوزت 10 مليون صف</strong> ولا يمكن تحميلها كاملاً في Import.</li>
        <li><strong>Real-Time مطلوب</strong> لبعض المقاييس الحيوية فقط وليس كل البيانات.</li>
        <li><strong>دمج مصادر مختلفة:</strong> قاعدة بيانات SQL حية + ملفات Excel ثابتة في نفس النموذج.</li>
        <li><strong>تحسين أداء DirectQuery</strong> بإضافة Aggregations على المستويات الأعلى.</li>
      </ul>
    </div>

    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>القيود المهمة:</strong> Composite Models لا تدعم بعض وظائف DAX (مثل USERELATIONSHIP مع DirectQuery tables في بعض السيناريوهات). RLS يتطلب اختباراً إضافياً عند الخلط بين الـ modes. تحتاج Premium أو Premium Per User للـ DirectQuery فوق Power BI Datasets.</p>
    </div>

    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>القاعدة العملية:</strong> ابدأ دائمًا بـ Import. انتقل إلى DirectQuery فقط إذا اضطررت (حجم أو Real-Time). انتقل إلى Composite Models فقط إذا احتجت أفضل الاثنين في نفس الوقت. كل مستوى يضيف تعقيدًا.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>What is a Composite Model?</h3>
      <p>A Composite Model lets you <strong>mix Import and DirectQuery storage modes in the same model</strong>. Some tables load into memory (Import) while others are queried live from the source (DirectQuery) — and they all work together in the same report.</p>
      <table class="compare-table">
        <tr>
          <th>The problem</th>
          <th>The solution</th>
        ...
        <tr>
          <td>Core Fact table is too large (1B+ rows)</td>
          <td>DirectQuery on the large Fact Table</td>
        </tr>
        <tr>
          <td>Dimension tables are small and need to be fast</td>
          <td>Import for Dimensions and Aggregations</td>
        </tr>
        <tr>
          <td>Report needs real-time on some data only</td>
          <td>DirectQuery for live data + Import for historical</td>
        </tr>
      </table>
    </div>

    <div class="lesson-card">
      <h3>Aggregation Tables — the real secret</h3>
      <p>An Aggregation Table is a pre-summarized table loaded into memory (Import mode) containing rolled-up data from the large Fact Table. When a user requests a high-level analysis, Power BI reads from the small Aggregation Table instead of firing a live query against the massive Fact Table.</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Build the aggregation table</h4>
            <p>In Power Query or your database, create a table with pre-aggregated data — for example: total sales by day, product, and region.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Set Storage Mode = Import</h4>
            <p>In Model View, select the Aggregation table and change its Storage Mode to Import. The original Fact Table stays on DirectQuery.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Configure Manage Aggregations</h4>
            <p>Right-click the Aggregation table → Manage Aggregations. Map each column to its counterpart in the Fact Table and specify the aggregation operation (Sum, GroupBy, Count…).</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">4</div>
          <div class="step-content">
            <h4>Verify the Aggregation Hit</h4>
            <p>In Performance Analyzer, look for "Aggregation Hit" in the DAX Studio output. If it appears, Power BI is reading from the fast in-memory table instead of querying the source.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>Data exceeds ~10 million rows</strong> and can't be fully loaded into Import.</li>
        <li><strong>Real-time is required</strong> for specific critical measures but not the entire dataset.</li>
        <li><strong>Combining different sources:</strong> a live SQL database alongside static Excel files in the same model.</li>
        <li><strong>Improving DirectQuery performance</strong> by adding Import-mode Aggregations for higher-level analyses.</li>
      </ul>
    </div>

    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>Important limitations:</strong> Composite Models don't support some DAX functions in all scenarios (e.g. USERELATIONSHIP with DirectQuery tables in certain cases). RLS requires additional testing when mixing storage modes. DirectQuery over Power BI Datasets requires Premium or Premium Per User.</p>
    </div>

    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>Practical rule:</strong> always start with Import. Move to DirectQuery only when forced by size or real-time requirements. Move to Composite Models only when you need the best of both. Each step up adds complexity — only climb when the business case justifies it.</p>
    </div>` }],
  },
  "visuals": {
    ...
    en_lede: "Every chart type in Power BI, what it's good for, and when to reach for something else.",
    sectionId: "visuals",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>مقدمة: رسم البيانات، ليس مجرد جداول</h3>
      <p>الدماغ البشري يستوعب <strong>الصور بـ 60,000 مرة أسرع</strong> من النصوص. المخطط الصحيح يحكي القصة في ثانية. المخطط الخاطئ يخفيها في رسوم معقدة.</p>
      <p><strong>القاعدة الذهبية:</strong> اختر المخطط الذي يظهر النمط (Pattern) الذي تريد إيصاله بأسرع وقت ممكن.</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>Combo Chart:</strong> دمج Column + Line في نفس المخطط. مثال: عرض المبيعات (عمود) والنسبة المئوية (خط) معاً.</li>
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>Waterfall Chart:</strong> عرض التغيير التراكمي (كيف انتقل الربح من 100 إلى 250). مخطط الـ Income Statement بالذات.</li>
        ...
        <li><strong>Card:</strong> أبسط مخطط — عدد واحد كبير. استخدمه لـ KPIs في أعلى التقرير (إجمالي الإيرادات).</li>
    ...
    <div class="lesson-card">
      <h3>الـ Field Wells — التحكم بأبعاد المخطط</h3>
      <p>كل مخطط له <strong>Field Wells</strong> (المناطق التي تسحب فيها الأعمدة):</p>
      <ul>
        ...
        <li><strong>Values:</strong> القيم العددية التي تعرض في المخطط (إجمالي المبيعات، الربح، العدد).</li>
      ...
      <p><strong>نصيحة:</strong> استخدم درجات (Hierarchy) في Category — مثلاً Year → Month → Day. ثم استخدم الـ Expand في المخطط للتنقيب التدريجي.</p>
    </div>

    <div class="lesson-card">
      <h3>تنسيق المخطط (Formatting)</h3>
      <p>بعد إنشاء المخطط، انقر على أيقونة الفرشاة (Format) لتخصيصه:</p>
      <ul>
    ...
    <div class="lesson-card">
      <h3>التفاعل بين المخططات (Cross-Filtering)</h3>
      <p>من أجمل مميزات Power BI: المخططات تتفاعل مع بعضها. إذا ضغطت على "مصر" في خريطة، كل أرقام التقرير ستتغير فوراً.</p>
      <ul>
        <li>كل مخطط يرسل Filter للمخططات الأخرى عند الضغط عليه.</li>
    ...
    <div class="lesson-card">
      ...
      <p>بدل خط واحد ملبك مع 20 منتج، أنشئ 20 مخطط مصغّر جنباً إلى جنب (واحد لكل منتج). يسهل المقارنة والبحث عن النمط.</p>
      <ul>
        <li>في خصائص المخطط، اسحب عمود في حقل "Small Multiples".</li>
    ...
    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>تحذير:</strong> في Power BI Desktop، المخططات Interactive (تفاعلية). في Power BI Service، لا تنسَ أن Mobile users قد لا يرى التفاصيل الدقيقة على الشاشة الصغيرة. اختبر على Mobile.</p>
    </div>

    <div class="lesson-card">
      <h3>🏆 Pro Tips من الخبرة الميدانية</h3>
      <ul>
        <li><strong>قاعدة الألوان:</strong> استخدم نفس اللون لنفس الفئة عبر كل المخططات. اللون الأحمر = مشكلة، الأخضر = نجاح. ثبّت هذا في ذهن المستخدم.</li>
        ...
        <li><strong>White Space = نظافة:</strong> لا تحشر 20 مخطط في صفحة واحدة. 5 مخططات جيدة أفضل من 20 سيئة. اترك مساحات فارغة.</li>
      </ul>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
...
<li><strong>White Space = Cleanliness:</strong> Don't cram 20 charts on one page. 5 good charts beat 20 bad ones. Leave empty spaces.</li>
  ...
  "sync-slicers": {
    ...
    en_lede: "Sync slicers across pages so one filter controls the entire report experience.",
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>أفضل ممارسة:</strong> استخدم Sync Slicers للفلاتر العالمية (السنة، المنطقة) وEdit Interactions=None للـ KPI Cards حتى لا تتغير بالضغط على المخططات.</p>
    </div>
...
<div class="step-content">
<h4>Sync setting</h4>
<p>Each page has two columns: <strong>Sync</strong> (applies the filter from this page) and <strong>Visible</strong> (shows the slicer on this page). You can sync without showing.</p>
</div>
</div>
</div>
</div>
...
<p><strong>Warning:</strong> Relative Date Slicer updates its range automatically based on today (last 30 days always changes). Make sure this is what you want — it may not suit historical reports.</p>
  ...
  "themes": {
    ...
    en_lede: "Set up a visual theme once and have it apply consistently across every page and report.",
    sectionId: "themes",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <div class="code-block">
{
  ...
  "visualStyles": {
    ...
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Power BI Themes</h3>
      <p>A Theme is a JSON file that defines default colors, fonts, and formatting for every element in your report — applied all at once.</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Apply a built-in theme</h4>
            <p>View ← Themes ← pick from the built-in options, or browse Microsoft's online theme gallery.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Customize the current theme</h4>
            <p>View ← Themes ← Customize Current Theme — you'll find a section for each element type (Cards, Charts, Text).</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Save and reuse across projects</h4>
            <p>View ← Themes ← Save Current Theme — exports a .json file you can share with the team or reuse in any report.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="lesson-card">
      <h3>Theme file structure (JSON)</h3>
      <div class="code-block">
{
  "name": "Corporate Theme",
  "dataColors": ["#0070C0","#00B050","#FF0000","#FFC000"],
  ...
  "visualStyles": {
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>3-color rule:</strong> One primary, one secondary, one for warnings. Don't add more.</li>
        <li><strong>Visual hierarchy:</strong> Large title → KPIs → Details. The eye follows the order naturally.</li>
        <li><strong>Alignment:</strong> Use Format → Align to keep elements in order — misalignment kills credibility.</li>
        <li><strong>Data labels:</strong> Show them only for values that matter — labeling everything creates noise.</li>
        <li><strong>Background:</strong> Light for print; dark for presentations.</li>
      </ul>
    </div>
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>Pro tip:</strong> Start each project with a "Design Guide" page — lay out your standard colors and components, then copy from it on every page. Saves time and keeps things consistent.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
...
<p><strong>The context is saved:</strong> The Tooltip inherits the context filter — if you look at a specific product on the chart, the Tooltip will display data for that specific product.</p>
  ...
  "custom-tooltips": {
    ...
    en_lede: "Replace the default hover tooltip with a rich custom page that shows exactly what your users need.",
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>مخصص:</strong> يعرض صفحة تقرير كاملة تحتوي على مخططات، KPIs، تفاصيل — كل ذلك في نافذة popup.</li>
      </ul>
    </div>
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>غير حجم الصفحة لـ Tooltip (View ← Page Size ← Tooltip). أضف KPIs ومخططات مصغّرة.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>مخطط Bar:</strong> Tooltip يعرض Trend خطي للمنتج عند hover.</li>
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>الـ Context محفوظ:</strong> الـ Tooltip يرث فلتر السياق — إذا وقفت على منتج معين في المخطط، الـ Tooltip سيعرض بيانات هذا المنتج تحديداً.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
<h3>Default vs. custom Tooltip</h3>
<ul>
...
<p><strong>The context is saved:</strong> The Tooltip inherits the context filter — if you look at a specific product on the chart, the Tooltip will display data for that specific product.</p>
  ...
  "condformat": {
    ...
    en_lede: "Use colors, icons, and data bars to guide the eye and surface what matters most.",
    sectionId: "condformat",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>الطريقة 1: Color Scale (التلوين التدريجي)</h3>
      <p>في أي Visual أو Matrix، اختار الحقل → Format → Conditional Formatting → Background Color → Rules = Color Scale. ستحدد: أقل قيمة → أعلى قيمة وألوانهم. Power BI يلوّن تلقائياً.</p>
    </div>
...
→ Rule 3: If Value >= 0  → Red
    ...
    <div class="lesson-card">
      ...
      <p>الأقوى على الإطلاق. تعمل Measure يرجع كود اللون (Hex أو اسم اللون) وتربطه بالـ Conditional Formatting:</p>
      <div class="code-block">
...
<span class="cm">-- ثم: Format → Background Color → Format Style: Field Value → اختار KPI Color</span>
    ...
    <div class="lesson-card">
      ...
      <p>في Matrix أو Table: اختار الحقل → Format → Conditional Formatting → Data Bars. تعمل شريط نسبي جوا الخلية مباشرة بدون Chart منفصل. مثالي لجداول KPI.</p>
    </div>
...
<span class="cm">-- Type: Number, Percent, or Percentile</span>
  ...
  "drillthrough": {
    ...
    en_lede: "Let users click from a summary view straight into a detailed analysis page — without losing context.",
    sectionId: "drillthrough",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Drill Down — التعمق في الهيرارشية</h3>
      <p>يعمل لما يكون عندك Hierarchy محددة (مثل: السنة ← الربع ← الشهر ← اليوم). الخطوات:</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>اسحب الـ Hierarchy كلها (وليس عمود واحد فقط) في خانة X-Axis في المخطط.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            ...
            <p>فوق المخطط ستجد زر السهم للأسفل ↓ — اضغطه ثم اضغط على أي عمود في المخطط للتعمق فيه.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>في صفحة التفاصيل، راحل Visualizations → اسحب عمود ProductName في خانة "Drill through". Power BI سيضيف زر Back تلقائياً.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>الاستخدام</h4>
            <p>ارجع للصفحة الرئيسية → كليك يمين على اسم منتج في أي مخطط → Drill through → تفاصيل المنتج.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-card">
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <div class="step-content">
            <h4>ربطها بالمخطط</h4>
            <p>في المخطط الرئيسي → Format → Tooltip → Type: Report Page → Page: اختار صفحة الـ Tooltip.</p>
          </div>
        </div>
      </div>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Drill Down — go deeper into a Hierarchy</h3>
      <p>Drill Down works when you've set up a Hierarchy (e.g. Year → Quarter → Month → Day). Here's how to use it:</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Create the Hierarchy</h4>
            <p>In the Data pane, right-click Year → New Hierarchy. Then drag Quarter, Month, and Day into it.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Put the Hierarchy on the Axis</h4>
            <p>Drag the whole Hierarchy (not individual columns) into the X-Axis field on the chart.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Enable Drill Down mode</h4>
            <p>The down-arrow button ↓ above the chart activates drill mode. Click it, then click any bar to drill into that period.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="lesson-card">
      <h3>Drill Through — jump to a details page</h3>
      <p>Drill Through lets users right-click any data point and jump to a dedicated details page. Setup:</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Create a details page</h4>
            <p>Add a new page and name it something like "Product Details". Design it to show everything relevant about a specific product.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Set up the Drill Through field</h4>
            <p>On the details page, go to Visualizations → drag <strong>ProductName</strong> into the <strong>Drill through</strong> box. Power BI will automatically add a Back button to the page.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Use it in the report</h4>
            <p>Back on any page → right-click a product name in any chart → Drill through → Product Details.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>Drill Down vs Drill Through:</strong> Drill Down goes deeper within the same visual along a hierarchy. Drill Through takes you to a completely different page focused on a specific record.</p>
    </div>` }],
  },
  "bookmarks": {
    ...
    en_lede: "Bookmarks capture a view state. Use them to build guided narratives, toggle layers, or create button-driven interactions.",
    sectionId: "bookmarks",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>ما هو الـ Bookmark؟</h3>
      <p>Bookmark = لقطة (Snapshot) لحالة التقرير في لحظة معينة — تشمل: أي الـ Visuals ظاهرة، الفلاتر المطبقة، والـ Slicers المختارة. عند الضغط على الـ Bookmark يُعيد التقرير لتلك اللحظة.</p>
    </div>
...
الخطوات:
1. صمّم Panel جانبي (مستطيل + مخططات)
...
5. زر X داخل Panel يرجع Panel Closed
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>Selection Pane:</strong> View → Selection. هذا اللوح بيوريك كل العناصر في الصفحة ويسمحلك تخفيها أو تجيبها بضغطة. يجب تفتحه وأنت تعمل على الـ Bookmarks.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
...
<p>Insert → Buttons → Navigator → Page Navigator. Power BI automatically generates a button for every page and updates the set when you add new ones.</p>
</div>
<div class="tip-box">
<div class="icon">💡</div>
<p><strong>Selection Pane:</strong> View → Selection. This panel displays all the elements on the page and allows you to hide or remove them with one click. You must open it while working on Bookmarks.</p>
  ...
  "publish": {
    ...
    en_lede: "Move your report from Desktop to Power BI Service and share it with the right people.",
    sectionId: "publish",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
...
<span class="cm">-- بدونها، التحديث التلقائي ما يشتغل</span>
    ...
    <div class="lesson-card">
      ...
      <p>بعد النشر، تستطيع تحدث البيانات تلقائياً حسب جدول محدد:</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
      ...
      <div class="steps">
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>اضغط "Share" أعلى يمين التقرير، وادخل البريد الإلكتروني للشخص أو المجموعة. تستطيع تعطيه "View" أو "Edit" صلاحيات.</p>
          </div>
        </div>
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>تستطيع تعطي صلاحيات أعمق على مستوى الـ Workspace (Admin, Member, Contributor, Viewer).</p>
          </div>
        </div>
...
<p>Either <strong>Power BI Pro</strong> (monthly) or <strong>Power BI Premium</strong> (higher). Free License can't publish.</p>
<div class="code-block">
...
<p><strong>Best practice:</strong> For large organizations, use Apps instead of direct sharing. App gives a professional impression and is cleaner for end users.</p>
  ...
  "workspaces": {
    ...
    en_lede: "Workspaces are how teams organize, share, and govern reports in Power BI Service.",
...
Viewer  → يشاهد فقط (يحتاج Pro أو Premium License)
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>Publish → اختار الـ Workspace بالاسم (وليس My Workspace). ستجد الـ Report والـ Dataset الاثنين رُفعوا.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>تقدر تعمل Audience مختلفة — مثلاً: Managers يشوفون صفحات معينة، Analysts يشوفون صفحات أخرى.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">4</div>
          <div class="step-content">
            <h4>Publish App</h4>
            <p>المستخدم يذهب إلى Apps في الـ Service ويضغط Get Apps ويرى تطبيقك منظمة وجميلة.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>أفضل ممارسة:</strong> مطوّرو التقارير يشتغلوا في الـ Workspace (Contributor/Member). المستخدمون النهائيون يستخدموا الـ App فقط (Viewer). هذا يمنع أي تعديل غير مقصود.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
<h3>My Workspace vs Shared Workspace</h3>
...
Member → Publish content, edit, but don't delete the Workspace
Contributor → publishes and edits but doesn't modify the work of others
...
<p><strong>Best practice:</strong> Report developers work in Workspace (Contributor/Member). End users only use the App (Viewer). This prevents any unintended modification.</p>
  ...
  "rls": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <div class="tip-box">
        <div class="icon">💡</div>
        <p><strong>الفكرة الأساسية:</strong> RLS تضيف فلتر DAX خفي تلقائياً قبل أن المستخدم يشوف أي بيانات.</p>
      </div>
    </div>
      ...
      <div class="steps">
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>قبل أن تبدأ RLS، تأكد عندك جدول مثل Dim_Region أو Dim_Manager بالمناطق والفروع:</p>
            <div class="code-block">
...
<span class="cm">-- إذا تبغى فلتر أعقد (مثلاً مدير يرى أكثر من منطقة):</span>
      ...
      <div class="steps">
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>يجب أن يكون عندك جدول Security بعمودين على الأقل:</p>
            <div class="code-block">
...
<span class="cm">-- سيجيب Cairo و Giza تلقائياً</span>
      ...
      <div class="tip-box">
        <div class="icon">💡</div>
        <p><strong>فائدة Dynamic RLS:</strong> إذا عملت مستخدم جديد، بدّل البيانات في Dim_Security بس — ما تحتاج تعدّل التقرير أو تنشر نسخة جديدة!</p>
      </div>
    </div>

    <div class="lesson-card">
      <h3>Object Level Security (OLS) — إخفاء أعمدة وجداول 🔒</h3>
      <p>RLS تُخفي <strong>صفوف</strong>. OLS تُخفي <strong>أعمدة أو جداول كاملة</strong> عن مستخدمين. مثال: مديرو المبيعات ما يرون عمود التكلفة (Cost).</p>
...
<span class="cm">-- لن يرون Cost حتى في Field List</span>
    ...
    <div class="lesson-card">
      ...
      <p>قبل النشر على Service، يجب اختبار RLS جيداً:</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
...
<span class="cm">-- Any other region shouldn't appear in charts</span>
</div>
</div>
</div>
...
<td style="padding:12px; border:1px solid var(--ink-3);">Slightly slower</td>
  ...
  "gateway": {
    ...
    en_lede: "The gateway bridges your on-premises data sources and Power BI Service, keeping scheduled refresh alive.",
    sectionId: "gateway",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
    ...
    <div class="lesson-card">
      ...
      <div class="steps">
        <div class="step">
          ...
          <div class="step-content">
            <h4>تنزيل Gateway</h4>
            <p>من powerbi.microsoft.com → نزّل On-Premises Data Gateway على الجهاز التي فيه البيانات (يجب أن يكون شغال دايماً).</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            ...
            <p>فتح الـ Gateway وسجّل بنفس حساب Power BI الخاص بيك. سيظهر في powerbi.com → Settings → Gateways.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
    ...
    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>مشكلة شائعة:</strong> إذا الـ Gateway انقطع أو انطفأ الجهاز، التحديث سيفشل. حل: ركّب الـ Gateway على سيرفر مخصص ثابت وليس على لابتوب شخصي.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>What is the Gateway?</h3>
      <p>The On-Premises Data Gateway is a piece of software you install on a machine inside your organization. Its job is to create a secure, encrypted tunnel between Power BI Service (in the cloud) and your internal data sources — SQL Server, shared network drives, on-prem databases, and so on. Without it, the cloud has no way to reach data that isn't public.</p>
    </div>
    <table class="compare-table">
      <tr>
        <th>Personal Gateway</th>
      ...
      <tr>
        <td>Single user, single device only.</td>
        <td>Shared — serves a whole team or workspace.</td>
      </tr>
      <tr>
        <td>Import mode only — no DirectQuery.</td>
        <td>Supports both Import and DirectQuery.</td>
      </tr>
      <tr>
        <td>Free. Good for personal projects.</td>
        <td>Requires Power BI Pro or Premium.</td>
      </tr>
    </table>
    <div class="lesson-card">
      <h3>Setting up the Gateway — step by step</h3>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Download the Gateway installer</h4>
            <p>Go to powerbi.microsoft.com → Download → On-Premises Data Gateway. Install it on the machine that has direct access to your data — it needs to stay on around the clock.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>Sign in and register</h4>
            <p>Open the Gateway application and sign in with the same account you use for Power BI. Once registered, it shows up in powerbi.com → Settings → Manage gateways.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            ...
            <p>In Service → Settings → Manage gateways → Add data source. Enter the server name, database name, and credentials for the internal system you want to reach.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">4</div>
          <div class="step-content">
            <h4>Connect your dataset</h4>
            <p>In Service → Dataset → Settings → Gateway connection → pick the Gateway and the data source you just added.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">5</div>
          <div class="step-content">
            <h4>Turn on scheduled refresh</h4>
            <p>Still in Dataset settings → Scheduled refresh → enable and set the refresh times. Pro licences support up to 8 refreshes per day.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>Common failure:</strong> If the Gateway machine shuts down or loses connectivity, every scheduled refresh fails. Install the Gateway on a dedicated, always-on server — not a personal laptop.</p>
    </div>` }],
  },
  "incremental": {
    eyebrow: "06 · 05 — Incremental Refresh",
    title: "Incremental Refresh — التحديث المتزايد",
    lede: "عندما تكون بياناتك كبيرة جداً (ملايين الصفوف)، تحديث كل شيء يومياً غير عملي. Incremental Refresh يُحدّث فقط البيانات الجديدة أو المعدّلة.",
    en_eyebrow: "06 · 05 — Incremental Refresh",
    en_lede: "Incremental refresh loads only new or changed rows instead of the full dataset — faster, cheaper, and more reliable.",
    sectionId: "incremental",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>المشكلة التي يحلها</h3>
      <p>إذا كان لديك 5 سنوات من بيانات المبيعات (50 مليون صف)، الـ Full Refresh اليومي يأخذ ساعات ويحمّل كل شيء من الصفر. Incremental Refresh بيقول: "البيانات من 2020 لـ 2024 ما اتغيرتش — حدّث أسبوع هذا الأسبوع فقط."</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li>جدول الـ Fact يجب يحتوي على عمود تاريخ من نوع DateTime.</li>
        <li>مصدر البيانات يجب يدعم Query Folding (SQL Server, SharePoint, Azure...).</li>
    ...
    [OrderDate] >= RangeStart &amp;&amp; [OrderDate] &lt; RangeEnd)
        ...
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>بعد النشر، Power BI Service سيقسّم البيانات لـ Partitions داخلياً. كل Refresh يُحدّث Partition الأيام الأخيرة فقط.</p>
          </div>
        </div>
      </div>
    </div>
...
<span class="cm">// وقت الـ Refresh: من 2 ساعة → 3 دقائق</span>
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>Query Folding اختبار:</strong> في Power Query، كليك يمين على الخطوة الأخيرة → View Native Query. إذا ظهر SQL Query = Query Folding يعمل ✅. إذا ظهر رسالة خطأ = لا يعمل ❌ وIncrementalRefresh لن يشتغل صح.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
<h3>The problem it solves</h3>
<p>If you have 5 years of sales data (50 million rows), daily Full Refresh takes hours and downloads everything from scratch. Incremental Refresh says: “The data from 2020 to 2024 hasn't changed — it only updated this week.”</p>
</div>
<div class="lesson-card">
<h3>Basic conditions</h3>
<ul>
<li><strong>Requires Power BI Premium or Premium Per User (PPU).</strong></li>
...
<li>It doesn't work with unsupported sources Query Folding (Files Excel local, CSV).</li>
</ul>
</div>
<div class="lesson-card">
  ...
  "performance": {
    ...
    <table class="compare-table">
      ...
      <tr>
        ...
        <td>فقط إذا البيانات > 1GB أو Real-Time مطلوب.</td>
      </tr>
    </table>
...
<span class="cm">   يُسبّب Expand Table يضرب حجم البيانات.</span>
...
<span class="cm">   الحل: استخدم REMOVEFILTERS(Column) بدل ALL(Table).</span>
      ...
      <div class="steps">
        <div class="step">
          ...
          <div class="step-content">
            ...
            <p>اضغط "Refresh visuals" وانتظر. كل Visual سيظهر الوقت الذي أخده.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
    ...
    <div class="lesson-card">
      ...
      <div class="code-block">
<span class="cm">✅ 1. Star Schema دائماً — ليس Flat Table</span>
<span class="cm">✅ 2. Measures بدل Calculated Columns</span>
<span class="cm">✅ 3. حدد أنواع البيانات في Power Query (لا تتركها Auto)</span>
...
<span class="cm">✅ 8. لا تستخدم IF() لمنع خطأ القسمة — استخدم DIVIDE()</span>
    ...
    <table class="compare-table">
      ...
      <tr>
        <td>Data is loaded into the .pbix file (VertiPaq compression).</td>
        <td>Every interaction sends a live query directly to the database.</td>
      </tr>
      <tr>
        <td>Very fast. Full DAX support.</td>
        <td>Slower. Some DAX functions are restricted.</td>
      </tr>
      <tr>
        <td>Data isn't real-time — needs a scheduled refresh.</td>
        <td>Always shows current data.</td>
      </tr>
      <tr>
        <td><span class="yes">✔ The default choice for ~90% of projects</span></td>
        <td>Use it when data exceeds 1 GB or real-time is a hard requirement.</td>
      </tr>
    </table>
    <div class="lesson-card">
      <h3>Common causes of slowness — and how to fix them</h3>
      <div class="code-block">
        <span class="cm">❌ 1. Too many Calculated Columns</span>
        <span class="cm">   Calculated Columns consume RAM and are recomputed on every refresh.</span>
        <span class="cm">   Fix: move the logic to Power Query (M Code) instead.</span>
        <span class="cm"></span>
        <span class="cm">❌ 2. Many-to-Many Relationships</span>
        <span class="cm">   Power BI expands the table internally, multiplying data size.</span>
        <span class="cm">   Fix: add a Bridge table to convert it to two 1:Many relationships.</span>
        <span class="cm"></span>
        <span class="cm">❌ 3. Bidirectional Filters</span>
        <span class="cm">   Each bidirectional relationship doubles the filter evaluation paths.</span>
        <span class="cm">   Fix: keep Single direction and use CROSSFILTER() in DAX only where needed.</span>
        <span class="cm"></span>
        <span class="cm">❌ 4. SUMX on large tables</span>
        <span class="cm">   SUMX iterates row by row — over a million rows it gets very slow.</span>
        <span class="cm">   Fix: pre-calculate the column in Power Query before it loads.</span>
        <span class="cm"></span>
        <span class="cm">❌ 5. ALL() on a large table inside a Measure</span>
        <span class="cm">   Fix: use REMOVEFILTERS(Column) instead of ALL(Table) to limit scope.</span>
      </div>
    </div>
    <div class="lesson-card">
      <h3>Performance Analyzer — measure each visual</h3>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>View → Performance Analyzer → Start Recording</h4>
            <p>Click "Refresh visuals" and wait. Each visual will show its total render time broken into components.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            ...
            <p>Each visual reports three timings: <strong>DAX Query</strong> (measure calculation), <strong>Visual Display</strong> (rendering), and <strong>Other</strong>. Focus on whichever DAX Query time is highest — that's usually the bottleneck.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Export to DAX Studio</h4>
            <p>Click "Copy query" on the slowest visual, then paste it into DAX Studio for deeper profiling — Server Timings will show exactly where the time is being spent.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>Rule of thumb:</strong> If DAX Query time is over 1 second, the issue is usually in the Measure logic or model structure. If Visual Display is slow, the problem is too many data points being rendered at once.</p>
    </div>` }],
  },
  "python-pbi": {
...
<p><strong>Ideal use:</strong> Use Interactive Report for Executive Dashboard (managers explore), and Paginated Report for periodic statements (automatically sent to each branch/customer).</p>
  ...
  "kpi-finance": {
    ...
    en_lede: "Revenue, profit margins, cash flow, and the ratios finance teams actually track.",
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">SUM</span>( Sales[Revenue] )
        ...
        <div class="kpi-importance">
          ...
          <p>أول مؤشر بيقرأه أي مستثمر. إذا الـ margin تنخفض مع الوقت، يعني التكاليف ترتفع أو الأسعار تنخفض — يجب تتدخل فوراً.</p>
        </div>
      </div>
    </div>
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">SUM</span>( Financials[Revenue] )
        ...
        <div class="kpi-example">
          ...
          الـ bottom line الحقيقية التي بتبقى عند الشركة من كل جنيه بتبيعه.</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">SUM</span>( Financials[Revenue] )
        ...
        <div class="kpi-example">
          ...
          OpEx Ratio = 16% — يعني 16 قرش من كل جنيه يذهب في تشغيل الشركة (مرتبات، إيجارات، تسويق...)</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>لو الإيرادات تزيد والـ ratio ثابت أو بيزيد، الشركة ليس بتستفيد من الـ scale. المطلوب إن الـ ratio ينخفض مع نمو الإيرادات.</p>
        </div>
      </div>
    </div>
...
<span class="fn">RETURN</span>
    ...
    <span class="fn">IF</span>( Trend < -<span class="num">0.1</span>, <span class="str">"✅ تحسن ممتاز"</span>, <span class="str">"🟢 مستقر"</span> )))
        ...
        <div class="kpi-example">
          ...
          يعني الديون زادت والأموال الخاصة انخفضت — يجب تتحقق من السبب.</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>البنوك والمستثمرون بيبصوا عليه قبل أي قرض. الاتجاه أهم من الرقم نفسه — D/E تزيد تدريجياً = خطر أكثر من ثابتة.</p>
        </div>
      </div>
    </div>
...
- <span class="fn">SUM</span>( Balance[Current_Liabilities] )
        ...
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>مؤشر السيولة الأساسي — شركة Working Capital سالب ممكن تفلس حتى وإن ربحانة على الورق! بيوضح قدرة الشركة على العمل اليومي.</p>
        </div>
      </div>
    </div>` }],
...
<p>Company revenues <strong>5,000,000 pounds</strong> And the cost of the goods <strong>3,000,000 pounds</strong>:<br/>
          Gross Profit = 2,000,000 ÷ 5,000,000 × 100 = <strong>40%</strong><br/>
          This means for every 100 pounds of sales, the company earns 40 pounds before operating expenses.</p>
</div>
<div class="kpi-importance">
...
<div class="kpi-importance">
<div class="imp-label">⭐ Importance</div>
<p>If revenues increase and the ratio is fixed or increasing, the company doesn't benefit from scale. What is required is that the ratio decreases as revenues grow.</p>
</div>
</div>
</div>
<!-- KPI 4: Return on Investment -->
...
<p>I spent <strong>1,000 pounds</strong> On a machine and you get a profit <strong>200 pounds</strong>:<br/>
          ROI = 200 ÷ 1,000 × 100 = <strong>20%</strong><br/>
          This means for every pound you invest, you'll get 1.20 pounds back.</p>
</div>
<div class="kpi-importance">
<div class="imp-label">⭐ Importance</div>
...
<div class="kpi-importance">
<div class="imp-label">⭐ Importance</div>
<p>The basic liquidity index - Working Capital is negative. It can go bankrupt even if it's profitable on paper! It demonstrates the company's ability to operate daily.</p>
</div>
</div>
</div>` }],
  },
  "kpi-sales": {
    ...
    lede: "المؤشرات الأساسية لقياس أداء فريق المبيعات ونمو الإيرادات وجودة العملاء. يجب تتابعها أسبوعياً ليس فقط شهرياً.",
    en_eyebrow: "09 · 02 — Sales KPIs",
    en_lede: "Sales volume, conversion rates, customer acquisition cost, churn — the metrics every sales dashboard needs.",
    sectionId: "kpi-sales",
    blocks: [{ kind: "html", html: `<div class="kpi-domain-header">
      <div class="kpi-domain-icon">📈</div>
      <div>
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">DISTINCTCOUNT</span>( Orders[Order_ID] )
        ...
        <div class="kpi-example">
          ...
          استراتأتية upselling ممكن ترفعه لـ 480 جنيه = زيادة 20% في الإيرادات!</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>رفع الـ AOV أرخص بكثير من اكتساب عملاء جدد. تتابعه مع استراتأتيات upsell وcross-sell لقياس فعاليتها.</p>
        </div>
      </div>
    </div>
...
<span class="fn">RETURN</span>
    AvgPurchase * PurchaseFreq * <span class="num">3</span> <span class="cm">-- إذا متوسط عمر العميل 3 سنوات</span>
        </div>
        <div class="kpi-example">
          <div class="ex-label">📊 مثال عملي</div>
        ...
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>بيحدد كم تقدر تصرف لاكتساب عميل جديد. شركات تعرف CLV تتنافس أقوى لأنها عارفة تُنفق وعلى ماذا.</p>
        </div>
      </div>
    </div>
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">COUNTROWS</span>( Pipeline )
        ...
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>بيكشف كفاءة فريق المبيعات في إغلاق الصفقات. إذا rate منخفض مع leads كثيرة = مشكلة في جودة المبيعات ليس جودة التسويق.</p>
        </div>
      </div>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="kpi-domain-header">
...
<p>Average customer purchase <strong>500 pounds</strong> - He buys <strong>4 times</strong> A year - and remains <strong>3 years</strong>:<br/>
          CLV = 500 × 4 × 3 = <strong>6,000 pounds</strong> - This means it's worth spending up to 2,000 pounds to acquire it.</p>
</div>
<div class="kpi-importance">
<div class="imp-label">⭐ Importance</div>
...
<span class="kw">Days in Inventory</span> = <span class="fn">DIVIDE</span>( <span class="num">365</span>, [Inventory Turnover] )
        ...
        <div class="kpi-example">
          ...
          إذا 2 مرات بس = مخزون راكد = خسارة في التمويل والتخزين.</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>مخزون بطيء = أموال محجوزة بدون عائد + تكاليف تخزين + خطر تلف. مخزون سريع جداً = خطر نفاد. يجب التوازن حسب طبيعة المنتج.</p>
        </div>
      </div>
    </div>
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">SUM</span>( Sales[Credit_Sales] )
        ...
        <div class="kpi-example">
          ...
          يعني الشركة تأخذ 30 يوم لتحصيل أموالها من العملاء في المتوسط.</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>DSO مرتفع = عملاء بيتأخروا في الدفع = ضغط على السيولة. إذا DSO > شروط الدفع المتفق عليها = مشكلة في التحصيل تحتاج تحقيق.</p>
        </div>
      </div>
    </div>
    ...
    <div class="kpi-card">
      ...
      <div class="kpi-card-body">
        <div class="kpi-grid">
          ...
          <div class="kpi-info-box"><div class="kpi-label">الاستراتأتية</div><p>اسعى لـ AP Days أطول من DSO = الشركة تأخذ أموالها قبل أن تدفعها</p></div>
        </div>
        <div class="kpi-formula-label">🔷 DAX Measure</div>
        <div class="kpi-formula-box">
...
<span class="fn">IF</span>( [AP Days] > [DSO], <span class="str">"✅ وضع سيولة جيد"</span>, <span class="str">"⚠️ ضغط على السيولة"</span> )
        ...
        <div class="kpi-example">
          <div class="ex-label">📊 مثال عملي</div>
          <p>DSO = <strong>30 يوم</strong> (تحصّل أموالك من العملاء في 30 يوماً)<br>
          AP Days = <strong>45 يوم</strong> (بتدفع للموردين بعد 45 يوم)<br>
          النتيجة: عندك <strong>15 يوم</strong> تستخدم فيها أموال الموردين — وضع مثالي!</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>التوازن بين DSO وAP Days هو سر إدارة السيولة. شركات مثل وول مارت بتحتفظ بـ AP Days عالية جداً كأداة تمويل مجانية من الموردين.</p>
        </div>
      </div>
    </div>
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">SUM</span>( Sales[Revenue] )
        ...
        <div class="kpi-example">
          ...
          Cost to Revenue = 76% — يعني 76 قرش من كل جنيه بيعات يذهب في التكاليف<br>
          هامش الربح الصافي المتاح = 24% فقط.</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>يوضح مدى تحوّل الإيرادات إلى أرباح. تابعه شهرياً وحلّل أين بالضبط ترتفع التكاليف — هل في COGS أم في المصاريف التشغيلية.</p>
        </div>
      </div>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="kpi-domain-header">
...
<p>accounts receivable: <strong>100,000</strong> — Annual forward sales: <strong>1,200,000</strong>:<br/>
          ...
          This means the company takes 30 days to collect its money from customers on average.</p>
</div>
<div class="kpi-importance">
<div class="imp-label">⭐ Importance</div>
...
<p>It explains how much revenue turns into profits. You follow it monthly and analyze where exactly the costs are rising — Are you in? COGS Nor in operating expenses.</p>
  ...
  "kpi-hr": {
    ...
    en_lede: "Headcount, turnover rate, absenteeism, and productivity — the people metrics that drive HR dashboards.",
    sectionId: "kpi-hr",
    blocks: [{ kind: "html", html: `<div class="kpi-domain-header">
      <div class="kpi-domain-icon">👥</div>
      <div>
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">AVERAGE</span>( HeadcountSnapshot[Headcount] )
        ...
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>Turnover مرتفع = تكاليف ضخمة + فقدان خبرات + تأثير على معنويات الفريق. يجب تحلل أسباب المغادرة بتفصيل عبر exit interviews.</p>
        </div>
      </div>
    </div>
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">SUM</span>( Attendance[Working_Days_Available] )
        ...
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>ارتفاع مفاجئ في الغياب = إنذار مبكر لمشاكل في بيئة العمل، ضغط عمل زائد، أو إدارة سيئة. اكشفه مبكراً قبل أن يتحول لـ turnover.</p>
        </div>
      </div>
    </div>
...
<span class="fn">DIVIDE</span>(
    ...
    <span class="fn">CALCULATE</span>(
        ...
        <div class="kpi-example">
          ...
          إذا وظفت 10 موظفين جدد وما زادش الرقم = كفاءة تنخفض.</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
...
<p>Revenue <strong>10,000,000 pounds</strong> - Number of employees <strong>50 employees</strong>:<br/>
          ...
          If you're hired 10 New employees and the number hasn't increased = Efficiency decreases.</p>
</div>
<div class="kpi-importance">
<div class="imp-label">⭐ Importance</div>
<p>The simplest measure of team productivity. Its rise with revenue growth means the company achieves real economies of scale from manpower.</p>
  ...
  "kpi-marketing": {
    ...
    lede: "مؤشرات قياس كفاءة الإنفاق التسويقي، اكتساب العملاء، والاحتفاظ بهم. يجب تُربط دائماً بإيرادات حقيقية ليس مجرد vanity metrics.",
    en_eyebrow: "09 · 05 — Marketing KPIs",
    en_lede: "CAC, LTV, ROAS, and conversion rate — the marketing metrics that connect spend to outcome.",
...
<span class="kw">CLV to CAC Ratio</span> = <span class="fn">DIVIDE</span>( [CLV], [CAC] )
        ...
        <div class="kpi-example">
          ...
          إذا CLV = 8,000 → نسبة 4:1 = استثمار ناجح جداً ✅</p>
        </div>
        <div class="kpi-importance">
          <div class="imp-label">⭐ الأهمية</div>
          <p>شركات كثيرة تُفلس لأنها تُنفق على اكتساب عملاء أكثر مما يحققونه. قياسه بدقة هو الفرق بين نمو مستدام ونمو انتحاري.</p>
        </div>
      </div>
    </div>
...
<span class="fn">RETURN</span> Promoters - Detractors
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>نصيحة احترافية:</strong> في Power BI، اربط كل الـ KPI domains ببعض في صفحة واحدة "Executive Dashboard" بـ slicers زمنية لأن المديرون يقدروا يشوفوا الصورة الكاملة بنظرة واحدة.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="kpi-domain-header">
<div class="kpi-domain-icon">📣</div>
<div>
...
<p>Spent <strong>50,000 pounds</strong> On Facebook Ads — generate revenue <strong>200,000 pounds</strong>:<br/>
          ROAS = 200,000 ÷ 50,000 = <strong>4x</strong> - This means for every pound of advertising, you'll get 4 pounds of sales back ✅</p>
</div>
<div class="kpi-importance">
<div class="imp-label">⭐ Importance</div>
...
<p>100 polls — 60 favorable (9-10) — 15 neutral (7-8) — 25 detractors (0-6):<br/>
          NPS = 60% − 25% = <strong>35</strong> - Good but there's room for improvement<br/>
...
<p><strong>Pro Tip:</strong> in Power BI, connect all the KPI domains Some on one page "Executive Dashboard" With slicers Timeframe so that managers can see the full picture at a glance.</p>
  ...
  "query-folding": {
    ...
    <div class="lesson-card">
      <h3>استراتأتية التعامل مع Folding</h3>
...
<p><strong>Result:</strong> Good performance with live data and available DAX features!</p>
  ...
  // ==================== درس محسن: أنواع الاتصال بالبيانات ====================
  "directquery": {
    eyebrow: "03 · 04 — أنواع الاتصال بالبيانات",
    title: "أنواع الاتصال بالبيانات",
    lede: "قبل بناء النموذج، يجب أن تقرر كيف ستتعامل Power BI مع البيانات نفسها: هل تستوردها إلى الملف، أم تستدعيها مباشرة من المصدر، أم تعتمد على نموذج حي جاهز؟",
    en_eyebrow: "03 · 04 — Power BI Connectivity Types",
    en_lede: "Import, DirectQuery, or Live Connection — what each mode means for your data, your model, and your refresh strategy.",
    sectionId: "directquery",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>الفكرة التي يبدأ منها القرار</h3>
      <p>هذه ليست مجرد خطوة تقنية صغيرة. اختيار نمط الاتصال يؤثر على <strong>سرعة التقرير</strong> و<strong>تحديث البيانات</strong> و<strong>مرونة النمذجة</strong> و<strong>الضغط على المصدر</strong>.</p>
      <ul>
        <li>هل يمكن تحميل هذه البيانات إلى الذاكرة بشكل عملي؟</li>
        <li>هل المستخدم يحتاج أرقامًا حية من المصدر أم تكفيه نسخة محدثة كل فترة؟</li>
        <li>هل تريد حرية كاملة في المقاييس والعلاقات، أم أنك مستعد للتنازل عن بعض المرونة؟</li>
        <li>هل المصدر نفسه قوي بما يكفي ليتحمل الاستعلامات المباشرة؟</li>
      </ul>
    </div>
    ...
    <div class="lesson-card">
      ...
      <table style="width:100%; border-collapse:collapse; margin:15px 0;">
        <tr style="background:var(--ink-light);">
          <th style="border:1px solid var(--ink-2); padding:10px; text-align:right;">الخاصية</th>
          <th style="border:1px solid var(--ink-2); padding:10px;">الاستيراد</th>
          <th style="border:1px solid var(--ink-2); padding:10px;">الاتصال المباشر</th>
          <th style="border:1px solid var(--ink-2); padding:10px;">الاتصال الحي</th>
        </tr>
        <tr>
          <td style="border:1px solid var(--ink-2); padding:10px; text-align:right;"><strong>مكان البيانات</strong></td>
          <td style="border:1px solid var(--ink-2); padding:10px;">داخل Power BI</td>
          <td style="border:1px solid var(--ink-2); padding:10px;">في المصدر الأصلي</td>
          <td style="border:1px solid var(--ink-2); padding:10px;">في نموذج خارجي جاهز</td>
        </tr>
        <tr>
          <td style="border:1px solid var(--ink-2); padding:10px; text-align:right;"><strong>الأداء</strong></td>
          <td style="border:1px solid var(--ink-2); padding:10px;">الأسرع غالبًا</td>
          <td style="border:1px solid var(--ink-2); padding:10px;">يعتمد على المصدر والشبكة</td>
          <td style="border:1px solid var(--ink-2); padding:10px;">غالبًا أفضل من الاتصال المباشر</td>
        </tr>
        <tr>
          <td style="border:1px solid var(--ink-2); padding:10px; text-align:right;"><strong>التحديث</strong></td>
          <td style="border:1px solid var(--ink-2); padding:10px;">يحتاج تحديثًا</td>
          <td style="border:1px solid var(--ink-2); padding:10px;">بيانات حية</td>
          <td style="border:1px solid var(--ink-2); padding:10px;">بيانات حية</td>
        </tr>
        <tr>
          <td style="border:1px solid var(--ink-2); padding:10px; text-align:right;"><strong>مرونة النمذجة</strong></td>
          <td style="border:1px solid var(--ink-2); padding:10px;">الأعلى</td>
          <td style="border:1px solid var(--ink-2); padding:10px;">أقل</td>
          <td style="border:1px solid var(--ink-2); padding:10px;">أقل بكثير</td>
        </tr>
      </table>
    </div>

    <div class="lesson-card">
      <h3>أولًا: الاستيراد</h3>
      <p><strong>ماذا يحدث فعليًا؟</strong> تقوم Power BI بسحب الصفوف من المصدر وتخزينها داخل محرك داخلي في الذاكرة. هذا ما يجعل الأداء سريعًا جدًا ويعطيك مرونة أعلى في التحليل.</p>
      <p><strong>لماذا يستخدم كثيرًا؟</strong></p>
      <ul>
        <li>لأنه النمط الافتراضي والأسهل في البداية.</li>
        <li>لأنه مناسب للتحليل التاريخي والمقارنات المعقدة.</li>
        <li>لأنه يعطيك أفضل مساحة عمل في المقاييس والعلاقات.</li>
      </ul>
      <p><strong>متى يصبح غير مناسب؟</strong></p>
      <ul>
        <li>إذا كان المصدر ضخمًا جدًا وزمن التحميل أو التحديث طويلًا.</li>
        <li>إذا كانت الحاجة تشغيلية وتتطلب رؤية شبه فورية.</li>
      </ul>
    </div>

    <div class="lesson-card">
      <h3>ثانيًا: الاتصال المباشر</h3>
      <p><strong>ماذا يحدث فعليًا؟</strong> لا يتم تحميل البيانات إلى الملف. كل تصفية أو نقرة ترسل استعلامًا إلى المصدر. لذلك يصبح اعتمادك أكبر على الخادم المصدر بدل جهازك الشخصي.</p>
      <p><strong>لماذا يبدو قويًا؟</strong></p>
      <ul>
        <li>لأنك تبقى قريبًا من أحدث نسخة من البيانات.</li>
        <li>لأنك لا تضطر إلى إدخال جداول ضخمة جدًا داخل الذاكرة.</li>
        <li>لأنه مناسب أكثر للتقارير التشغيلية سريعة التغير.</li>
      </ul>
      <p><strong>لكن ما القيود المهمة؟</strong></p>
      <ul>
        <li>ليس كل مصدر يدعم هذا النمط أصلًا.</li>
        <li>الأداء قد يصبح ضعيفًا إذا كان المصدر أو الاستعلامات غير محسنة.</li>
        <li>بعض مرونة النمذجة والمقاييس تكون أقل من الاستيراد.</li>
        <li>قد تضغط مباشرة على قاعدة البيانات الإنتاجية.</li>
      </ul>
    </div>

    <div class="lesson-card">
      <h3>ثالثًا: الاتصال الحي</h3>
      <p><strong>الفكرة الأساسية:</strong> هو قريب من الاتصال المباشر من حيث أن البيانات لا تدخل الملف، لكنك هنا تتصل غالبًا <strong>بنموذج تحليلي جاهز</strong> مثل خدمات التحليل أو نموذج مركزي منشور مسبقًا.</p>
      <p><strong>لماذا يكون مختلفًا في التجربة؟</strong></p>
      <ul>
        <li>لأنك لا تتعامل فقط مع جداول خام، بل مع نموذج مُعد لخدمة التقارير.</li>
        <li>لأن المقاييس والتعاريف والأمان قد تكون موحدة على مستوى المؤسسة.</li>
        <li>لأنه ممتاز عندما تريد بناء تقارير بصرية فوق نموذج يملكه فريق آخر.</li>
      </ul>
      <p><strong>ما حدوده؟</strong></p>
      <ul>
        <li>مرونتك داخل الملف أقل لأن النموذج ليس ملكك بالكامل.</li>
        <li>يعتمد على بنية جاهزة ومؤسسة تعمل أصلًا بهذا الأسلوب.</li>
      </ul>
    </div>

    <div class="lesson-card">
      <h3>التفكير الهجين</h3>
      <p>في كثير من المشاريع الحديثة، لا تحتاج إلى اختيار لون واحد فقط. أحيانًا يكون أفضل حل هو الدمج بين أكثر من نمط.</p>
      <ul>
        <li>جدول معاملات ضخم جدًا يبقى مباشرًا.</li>
        <li>جداول الأبعاد الصغيرة والجداول المساعدة تُستورد.</li>
        <li>النتيجة: توازن أفضل بين السرعة وحداثة البيانات.</li>
      </ul>
    </div>

    <div class="warn-box">
      <div class="icon">⚠️</div>
      <p><strong>التحذير الأهم:</strong> لا تختَر النمط لأن اسمه يبدو أقوى أو أحدث. اختره بناءً على حجم البيانات، وحداثتها المطلوبة، وقدرة المصدر، ومرونتك التحليلية المطلوبة.</p>
    </div>

    <div class="tip-box">
      <div class="icon">🧠</div>
      <p><strong>قاعدة سريعة:</strong> إذا كانت الأولوية للسرعة ومرونة التحليل فابدأ بالاستيراد. إذا كانت البيانات ضخمة أو حية جدًا فانظر في الاتصال المباشر. إذا كانت المؤسسة لديها نموذج مركزي جاهز فالاتصال الحي غالبًا هو الطريق الأنسب.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
<h3>The idea behind the decision</h3>
<p>This isn't a tiny technical setting. Your connectivity choice changes <strong>performance</strong>, <strong>freshness</strong>, <strong>modeling freedom</strong>, and <strong>load on the source system</strong>.</p>
<ul>
<li>Can the data realistically be held in memory?</li>
<li>Do users need live source values, or is scheduled freshness enough?</li>
<li>Do you need full flexibility in measures and relationships?</li>
<li>Is the source platform strong enough to serve direct queries well?</li>
</ul>
</div>
...
<tr>
<td style="border:1px solid var(--ink-2); padding:10px;"><strong>Where data lives</strong></td>
<td style="border:1px solid var(--ink-2); padding:10px;">Inside Power BI</td>
<td style="border:1px solid var(--ink-2); padding:10px;">In the source</td>
<td style="border:1px solid var(--ink-2); padding:10px;">In an external semantic model</td>
</tr>
<tr>
<td style="border:1px solid var(--ink-2); padding:10px;"><strong>Performance</strong></td>
<td style="border:1px solid var(--ink-2); padding:10px;">Usually fastest</td>
<td style="border:1px solid var(--ink-2); padding:10px;">Depends on source and network</td>
<td style="border:1px solid var(--ink-2); padding:10px;">Often better than DirectQuery</td>
</tr>
<tr>
<td style="border:1px solid var(--ink-2); padding:10px;"><strong>Freshness</strong></td>
<td style="border:1px solid var(--ink-2); padding:10px;">Needs refresh</td>
<td style="border:1px solid var(--ink-2); padding:10px;">Live</td>
<td style="border:1px solid var(--ink-2); padding:10px;">Live</td>
</tr>
<tr>
<td style="border:1px solid var(--ink-2); padding:10px;"><strong>Modeling freedom</strong></td>
<td style="border:1px solid var(--ink-2); padding:10px;">Highest</td>
<td style="border:1px solid var(--ink-2); padding:10px;">Lower</td>
<td style="border:1px solid var(--ink-2); padding:10px;">Much lower</td>
</tr>
</table>
</div>
...
<div class="lesson-card">
<h3>First: Import</h3>
<p><strong>What actually happens?</strong> Power BI extracts rows from the source and stores them in an internal in-memory engine. That is why performance is often very fast and analytical flexibility is higher.</p>
<p><strong>Why it's commonly used:</strong></p>
<ul>
<li>It is the default and easiest starting point.</li>
<li>It suits historical analysis and deep comparisons well.</li>
<li>It gives you the most freedom in measures and relationships.</li>
</ul>
<p><strong>When it becomes a bad fit:</strong></p>
<ul>
<li>When the source is extremely large and refresh becomes painful.</li>
<li>When the business need is operational and near-real-time.</li>
</ul>
</div>

<div class="lesson-card">
<h3>Second: DirectQuery</h3>
<p><strong>What actually happens?</strong> No rows are loaded into the file. Every filter or interaction sends a query back to the source. This shifts more of the burden to the source server rather than your machine.</p>
<p><strong>Why it looks powerful:</strong></p>
<ul>
<li>You stay close to the latest version of the data.</li>
<li>You avoid importing extremely large tables into memory.</li>
<li>It fits operational reporting better.</li>
</ul>
<p><strong>But what are the limits?</strong></p>
<ul>
<li>Not every source supports it.</li>
<li>Performance can suffer if the source or queries are weak.</li>
<li>You usually lose some modeling freedom compared with Import.</li>
<li>You may put direct pressure on a production database.</li>
</ul>
</div>

<div class="lesson-card">
<h3>Third: Live Connection</h3>
<p><strong>The main idea:</strong> it's similar to DirectQuery in that data isn't imported, but you usually connect to a prepared semantic model such as Analysis Services or a published centralized dataset.</p>
<p><strong>Why the experience is different:</strong></p>
<ul>
<li>You are often querying a prepared analytical model, not raw tables only.</li>
<li>Definitions, security, and business logic may already be centralized.</li>
<li>It is strong for enterprise reporting on top of a model owned by another team.</li>
</ul>
<p><strong>Its limits:</strong></p>
<ul>
<li>Your freedom inside the file is lower.</li>
<li>It depends on an organization already working with central models.</li>
</ul>
</div>

<div class="lesson-card">
<h3>Composite thinking</h3>
<p>Modern Power BI doesn't always force a single-color answer. Sometimes the best design mixes patterns:</p>
<ul>
<li>Keep the very large fact table direct.</li>
<li>Import the smaller dimensions and helper tables.</li>
<li>Balance speed with freshness.</li>
</ul>
</div>

<div class="warn-box">
<div class="icon">⚠️</div>
<p><strong>Most important warning:</strong> don't choose a mode because its name sounds more advanced. Choose based on data size, required freshness, source capability, and the modeling freedom you need.</p>
</div>

<div class="tip-box">
<div class="icon">🧠</div>
<p><strong>Fast rule of thumb:</strong> if speed and analytical flexibility are the priority, start with Import. If the data is too large or too live, evaluate DirectQuery. If the organization already owns a central semantic model, Live Connection is often the best path.</p>
</div>` }],
  },
  ...
  "tabular-editor": {
    ...
    en_lede: "Tabular Editor gives you a faster, more disciplined way to build and maintain data models outside of Desktop.",
...
<p><strong>Caution:</strong> Tabular Editor is very powerful, so be careful with incorrect edits. Always save a copy of the model before making bulk changes.</p>
  ...
  "mobile-design": {
    ...
    en_lede: "Most reports are built for desktop and break on mobile. Here's how to design layouts that work on both.",
...
<p><strong>Warning:</strong> Not testing the report on mobile before publishing can cause poor user experience. Always test on real devices.</p>
  ...
  "ai-visuals": {
    ...
    blocks: [
      { kind: "html", html: `
<div class="lesson-card">
  <h3>المرئيات الذكية في Power BI</h3>
  <div class="lesson-card-body">
    <p>Power BI يوفر أربعة مرئيات مدعومة بالذكاء الاصطناعي مُدمجة مباشرة — لا تحتاج بيانات تدريب أو نماذج خارجية. كل مرئية تحل نوعاً مختلفاً من الأسئلة التحليلية.</p>
    <div class="compare-table">
      <table>
        <thead><tr><th>المرئية</th><th>السؤال الذي تُجيب عليه</th></tr></thead>
        <tbody>
          <tr><td><strong>Key Influencers</strong></td><td>ما العوامل التي تؤثر على نتيجة معينة؟</td></tr>
          <tr><td><strong>Decomposition Tree</strong></td><td>كيف تتوزع قيمة ما على الأبعاد المختلفة؟</td></tr>
          <tr><td><strong>Q&amp;A Visual</strong></td><td>اكتب سؤالاً بالعربية أو الإنجليزية واحصل على مرئية</td></tr>
          <tr><td><strong>Smart Narrative</strong></td><td>تلخيص تلقائي للبيانات بلغة طبيعية</td></tr>
        </tbody>
      </table>
    </div>
  </div>
      ...
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Key Influencers — محلّل العوامل المؤثرة</h3>
  <div class="lesson-card-body">
    <p>تُجيب على سؤال: <strong>"ما الذي يجعل قيمة X ترتفع أو تنخفض؟"</strong> تستخدم خوارزميات إحصائية لاكتشاف الارتباطات وترتيب العوامل المؤثرة.</p>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>حدد الحقل المراد تحليله</strong> (Analyze): مثل "Customer Satisfaction Score" أو "Churn Rate"
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>أضف العوامل المحتملة</strong> (Explain by): المنطقة، الفئة، الوكيل، النوع — كل ما قد يُؤثر
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>اقرأ النتائج</strong>: "عندما يكون النوع = Premium، الرضا يرتفع بمعدل 2.3×" — النسبة تعني قوة التأثير
      </div></div>
    </div>
    <div class="tip-box">
      <strong>تبويب Top Segments:</strong> بدلاً من عامل واحد، يعرض مجموعات (Segments) تجمع عدة شروط معاً لتحديد أعلى أو أدنى القيم.
    </div>
    <div class="warn-box">
      <strong>تنبيه:</strong> Key Influencers لا تثبت السببية — تكشف الارتباط فقط. استخدمها لصياغة الفرضيات وليس الاستنتاجات النهائية.
    </div>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Q&amp;A Visual — اسأل بياناتك بلغتك</h3>
  <div class="lesson-card-body">
    <p>Q&amp;A يُتيح كتابة أسئلة بلغة طبيعية فيُترجمها تلقائياً إلى مرئية. يدعم العربية والإنجليزية واللهجات المختلطة.</p>
    <ul>
      <li><strong>مثال:</strong> "إجمالي المبيعات حسب المنطقة في 2024" → مخطط شريطي فوري</li>
      <li><strong>مثال:</strong> "أعلى 5 منتجات مبيعاً" → جدول مرتب تلقائياً</li>
      <li><strong>تحسين الدقة:</strong> افتح Q&amp;A Setup في Service لإضافة مرادفات (Synonyms) للمصطلحات</li>
    </ul>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>إعداد Synonyms:</strong> في Power BI Service → مجموعة العمل → Dataset Settings → Q&amp;A Synonyms. أضف "مبيعات" = "Revenue" = "Sales Amount"
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>تحديد الحقول المرئية:</strong> Q&amp;A يعمل فقط على الحقول الموجودة في نموذج البيانات — تأكد من وضوح أسماء الأعمدة
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>تثبيت المرئية:</strong> بعد الحصول على الإجابة يمكن تثبيتها كمرئية عادية في التقرير باستخدام "Pin Visual"
      </div></div>
    </div>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Smart Narrative — تلخيص تلقائي بالنص</h3>
  <div class="lesson-card-body">
    <p>Smart Narrative تُنشئ فقرة نصية تلقائية تُلخّص أبرز ما في بياناتك — تتحدث بالأرقام وتُشير للاتجاهات والقيم القصوى.</p>
    <div class="tip-box">
      <strong>مثال ناتج:</strong> "إجمالي المبيعات 4.5 مليون. أعلى شهر كان يناير بـ 850 ألف (+12% عن الشهر السابق). المنطقة الشمالية تُمثّل 38% من المجموع."
    </div>
    <ul>
      <li><strong>تخصيص النص:</strong> انقر على القيم في النص لتُعدّل الصياغة أو تُضيف حقلاً جديداً من النموذج</li>
      <li><strong>ديناميكي:</strong> النص يتغير تلقائياً مع الفلاتر — إذا اخترت منطقة، السرد يُركّز عليها</li>
      <li><strong>الاستخدام الأمثل:</strong> في رأس التقرير كـ "Executive Summary" أو ملاحظة تفسيرية بجانب مخطط معقد</li>
    </ul>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Anomaly Detection — كشف الشذوذات التلقائي</h3>
  <div class="lesson-card-body">
    <p>Anomaly Detection مُدمجة في مخططات الخطوط (Line Charts) — تُحدد تلقائياً النقاط التي تنحرف بشكل غير عادي عن الاتجاه المتوقع.</p>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>تفعيل:</strong> انقر على Line Chart → Analytics pane → Add Anomaly Detection. حدد الـ Sensitivity (1–100) — القيمة الأعلى تكشف شذوذات أكثر
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>الاستكشاف:</strong> انقر على نقطة الشذوذ ← تظهر لوحة "Explain Anomaly" تُوضّح أبرز العوامل المُساهِمة (مثل: المنطقة الجنوبية انخفضت 40%)
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>الضبط:</strong> اضبط نافذة التوقع (Expected Range Width) حسب تقلّب بياناتك — بيانات موسمية تحتاج نطاقاً أوسع
      </div></div>
    </div>
    <div class="warn-box">
      <strong>متطلب:</strong> Anomaly Detection تحتاج بُعداً زمنياً على المحور — تعمل فقط مع مخططات السلاسل الزمنية.
    </div>
  </div>
</div>` },
    ],
    en_blocks: [
      { kind: "html", html: `
<div class="lesson-card">
  <h3>AI Visuals in Power BI</h3>
  <div class="lesson-card-body">
    <p>Power BI ships with four AI-powered visuals built right in — no training data, no external models. Each one answers a different type of analytical question.</p>
    <div class="compare-table">
      <table>
        <thead><tr><th>Visual</th><th>Question it answers</th></tr></thead>
        <tbody>
          <tr><td><strong>Key Influencers</strong></td><td>What factors drive a particular outcome up or down?</td></tr>
          <tr><td><strong>Decomposition Tree</strong></td><td>How does a value break down across multiple dimensions?</td></tr>
          <tr><td><strong>Q&amp;A Visual</strong></td><td>Ask a natural-language question, get a visual back</td></tr>
          <tr><td><strong>Smart Narrative</strong></td><td>Auto-generated plain-language summary of your data</td></tr>
        </tbody>
      </table>
    </div>
  </div>
      ...
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Key Influencers — What's Driving Your Metric?</h3>
  <div class="lesson-card-body">
    <p>Answers: <strong>"What makes X go up or down?"</strong> It uses statistical algorithms to surface correlations and rank the factors by impact.</p>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>Set the target field</strong> (Analyze): e.g. "Customer Satisfaction Score" or "Churn Rate"
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>Add potential drivers</strong> (Explain by): Region, Category, Agent, Type — anything that might influence the outcome
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>Read the results</strong>: "When Type = Premium, satisfaction is 2.3× higher" — the multiplier indicates strength of influence
      </div></div>
    </div>
    <div class="tip-box">
      <strong>Top Segments tab:</strong> Instead of single factors, shows groups (segments) combining multiple conditions to identify the highest or lowest value clusters.
    </div>
    <div class="warn-box">
      <strong>Important:</strong> Key Influencers shows correlation, not causation. Use it to form hypotheses, not draw final conclusions.
    </div>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Q&amp;A Visual — Ask Your Data in Plain Language</h3>
  <div class="lesson-card-body">
    <p>Q&amp;A lets users type natural-language questions and get visuals back instantly. It supports English, Arabic, and mixed queries.</p>
    <ul>
      <li><strong>Example:</strong> "total sales by region in 2024" → instant bar chart</li>
      <li><strong>Example:</strong> "top 5 products by revenue" → auto-sorted table</li>
      <li><strong>Improve accuracy:</strong> Open Q&amp;A Setup in Service and add synonyms for your business terms</li>
    </ul>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>Set up Synonyms:</strong> Power BI Service → Workspace → Dataset Settings → Q&amp;A Synonyms. Add "revenue" = "sales amount" = "total sales"
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>Expose the right fields:</strong> Q&amp;A only sees fields in your model — clear, descriptive column names make a huge difference
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>Pin the answer:</strong> Once you get the right visual, pin it to the report with "Pin Visual" — it becomes a regular visual
      </div></div>
    </div>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Smart Narrative — Auto-Generated Text Summaries</h3>
  <div class="lesson-card-body">
    <p>Smart Narrative generates a text paragraph that automatically summarizes the highlights of your data — citing numbers, trends, and peaks.</p>
    <div class="tip-box">
      <strong>Example output:</strong> "Total sales were 4.5M. January was the peak month at 850K (+12% vs. prior month). The North region accounts for 38% of total."
    </div>
    <ul>
      <li><strong>Customize the text:</strong> Click any value in the narrative to edit the phrasing or add a field from your model</li>
      <li><strong>Fully dynamic:</strong> The text updates automatically with filters — selecting a region shifts the narrative to focus on it</li>
      <li><strong>Best use:</strong> As an "Executive Summary" header on the report, or as an explanatory note next to a complex chart</li>
    </ul>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Anomaly Detection — Automatic Outlier Flagging</h3>
  <div class="lesson-card-body">
    <p>Anomaly Detection is built into Line Charts — it automatically flags data points that deviate unusually from the expected trend.</p>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>Enable it:</strong> Click a Line Chart → Analytics pane → Add Anomaly Detection. Set Sensitivity (1–100) — higher values surface more anomalies
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>Investigate:</strong> Click an anomaly point → "Explain Anomaly" panel opens, showing the top contributing factors (e.g., "South region dropped 40%")
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>Tune it:</strong> Adjust the Expected Range Width based on your data's natural volatility — seasonal data needs a wider range
      </div></div>
    </div>
    <div class="warn-box">
      <strong>Requirement:</strong> Anomaly Detection needs a time dimension on the axis — it only works with time-series line charts.
    </div>
  </div>
</div>` },
    ],
  ...
  "storytelling": {
    eyebrow: "05 \u00b7 09 \u2014 \u0633\u0631\u062f \u0627\u0644\u0642\u0635\u0629 \u0628\u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a",
    title: "\u0633\u0631\u062f \u0627\u0644\u0642\u0635\u0629 \u0628\u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a",
    lede: "\u062d\u0648\u0644 \u0627\u0644\u0623\u0631\u0642\u0627\u0645 \u0645\u0646 \u0639\u0631\u0636 \u0645\u062a\u0641\u0631\u0642 \u0625\u0644\u0649 \u0631\u0633\u0627\u0644\u0629 \u0648\u0627\u0636\u062d\u0629 \u062a\u062c\u0639\u0644 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645 \u064a\u0641\u0647\u0645 \u0645\u0627\u0630\u0627 \u062d\u062f\u062b\u060c \u0648\u0644\u0645\u0627\u0630\u0627\u060c \u0648\u0645\u0627 \u0627\u0644\u062e\u0637\u0648\u0629 \u0627\u0644\u062a\u0627\u0644\u064a\u0629.",
    en_eyebrow: "05 \u00b7 09 \u2014 Storytelling with Data",
    en_lede: "Numbers need context. Turn your visuals into a clear narrative — what happened, why it happened, and what comes next.",
    sectionId: "storytelling",
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>\u0645\u0646 \u0627\u0644\u0631\u0642\u0645 \u0625\u0644\u0649 \u0627\u0644\u0631\u0633\u0627\u0644\u0629</h3>
      <p>\u0627\u0644\u0647\u062f\u0641 \u0645\u0646 \u0627\u0644\u0635\u0641\u062d\u0629 \u0644\u064a\u0633 \u0639\u0631\u0636 \u0643\u0644 \u0634\u064a\u0621\u060c \u0628\u0644 \u062a\u0631\u062a\u064a\u0628 \u0645\u0627 \u064a\u0647\u0645 \u062d\u062a\u0649 \u064a\u0641\u0647\u0645 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645: \u0645\u0627\u0630\u0627 \u062d\u062f\u062b\u060c \u0648\u0644\u0645\u0627\u0630\u0627 \u062d\u062f\u062b\u060c \u0648\u0645\u0627 \u0627\u0644\u0645\u0637\u0644\u0648\u0628 \u0628\u0639\u062f \u0630\u0644\u0643.</p>
      <ul>
        <li><strong>\u0627\u0628\u062f\u0623 \u0628\u0639\u0646\u0648\u0627\u0646 \u064a\u0633\u062a\u0646\u062a\u062c:</strong> \u0627\u0644\u0639\u0646\u0648\u0627\u0646 \u064a\u0642\u0648\u0644 \u0627\u0644\u0646\u062a\u064a\u062c\u0629 \u0648\u0644\u064a\u0633 \u0627\u0633\u0645 \u0627\u0644\u0645\u0648\u0636\u0648\u0639.</li>
        <li><strong>\u0642\u0644\u0644 \u0627\u0644\u0623\u062f\u0644\u0629:</strong> \u0628\u0637\u0627\u0642\u0627\u062a \u0642\u0644\u064a\u0644\u0629 + \u0631\u0633\u0645 \u0631\u0626\u064a\u0633\u064a + \u062f\u0644\u064a\u0644 \u0645\u0633\u0627\u0639\u062f.</li>
        <li><strong>\u0627\u0631\u0628\u0637 \u0627\u0644\u062a\u0641\u0627\u0639\u0644 \u0628\u0627\u0644\u0642\u0631\u0627\u0631:</strong> \u0644\u0627 \u062a\u0636\u0639 \u0641\u0644\u0627\u062a\u0631 \u0648\u0623\u0632\u0631\u0627\u0631\u064b\u0627 \u0628\u062f\u0648\u0646 \u0633\u0628\u0628.</li>
      </ul>
    </div>

    <div class="lesson-card">
      <h3>\u0642\u0627\u0644\u0628 \u0633\u0631\u064a\u0639 \u0644\u0635\u0641\u062d\u0629 \u0646\u0627\u062c\u062d\u0629</h3>
      <table class="compare-table">
        <tr>
          <th>\u0627\u0644\u0639\u0646\u0635\u0631</th>
          <th>\u062f\u0648\u0631\u0647</th>
        ...
        <tr>
          <td><strong>\u0639\u0646\u0648\u0627\u0646 \u0627\u0633\u062a\u0646\u062a\u0627\u062c\u064a</strong></td>
          <td>\u064a\u0644\u062e\u0635 \u0627\u0644\u0631\u0633\u0627\u0644\u0629 \u0641\u064a \u0633\u0637\u0631 \u0648\u0627\u062d\u062f.</td>
        </tr>
        <tr>
          <td><strong>\u0645\u0624\u0634\u0631\u0627\u062a \u0633\u0631\u064a\u0639\u0629</strong></td>
          <td>\u062a\u0639\u0637\u064a \u0646\u0638\u0631\u0629 \u0623\u0648\u0644\u0649 \u0642\u0628\u0644 \u0627\u0644\u062a\u0641\u0635\u064a\u0644.</td>
        </tr>
        <tr>
          <td><strong>\u0631\u0633\u0645 \u0631\u0626\u064a\u0633\u064a</strong></td>
          <td>\u064a\u062d\u0645\u0644 \u0627\u0644\u0641\u0643\u0631\u0629 \u0627\u0644\u0623\u0633\u0627\u0633\u064a\u0629.</td>
        </tr>
        <tr>
          <td><strong>\u062f\u0644\u064a\u0644 \u0645\u0633\u0627\u0639\u062f</strong></td>
          <td>\u064a\u0641\u0633\u0631 \u0627\u0644\u0633\u0628\u0628 \u0623\u0648 \u064a\u062f\u0639\u0645 \u0627\u0644\u0627\u0633\u062a\u0646\u062a\u0627\u062c.</td>
        </tr>
      </table>
    </div>
    ...
    <div class="tip-box">
      <div class="icon">\u2705</div>
      <p><strong>\u0627\u062e\u062a\u0628\u0627\u0631 \u0633\u0631\u064a\u0639:</strong> \u0625\u0630\u0627 \u0628\u0642\u064a \u0627\u0644\u0639\u0646\u0648\u0627\u0646 \u0648\u0627\u0644\u0645\u0624\u0634\u0631\u0627\u062a \u0648\u0627\u0644\u0631\u0633\u0645 \u0627\u0644\u0631\u0626\u064a\u0633\u064a \u0648\u062d\u062f\u0647\u0645 \u0645\u0641\u0647\u0648\u0645\u064a\u0646، \u0641\u0623\u0646\u062a \u062a\u0642\u062a\u0631\u0628 \u0645\u0646 \u0635\u0641\u062d\u0629 \u062a\u062d\u0643\u064a \u0642\u0635\u0629 \u0628\u0648\u0636\u0648\u062d.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>From numbers to message</h3>
      <p>The goal of the page isn't to show everything. It is to arrange what matters so the user understands what happened, why it happened, and what should happen next.</p>
      <ul>
        <li><strong>Start with a conclusion title:</strong> the title should state the result, not only the topic.</li>
        <li><strong>Reduce the evidence:</strong> a few KPIs, one dominant visual, and one supporting proof point are often enough.</li>
        <li><strong>Connect interaction to decisions:</strong> filters and buttons should exist for a reason.</li>
      </ul>
    </div>

    <div class="lesson-card">
      <h3>A fast structure for a strong page</h3>
      <table class="compare-table">
        <tr>
          <th>Element</th>
          <th>Role</th>
        ...
        <tr>
          <td><strong>Conclusion title</strong></td>
          <td>Summarizes the message in one line.</td>
        </tr>
        <tr>
          <td><strong>Headline KPIs</strong></td>
          <td>Give an immediate first read.</td>
        </tr>
        <tr>
          <td><strong>Dominant visual</strong></td>
          <td>Carries the core idea of the page.</td>
        </tr>
        <tr>
          <td><strong>Supporting proof</strong></td>
          <td>Explains the cause or validates the conclusion.</td>
        </tr>
      </table>
    </div>
    ...
    <div class="tip-box">
      <div class="icon">?</div>
      <p><strong>Quick test:</strong> if the title, KPIs, and dominant visual are enough to explain the message, the page is probably telling a clear story.</p>
    </div>` }],
  },
  "dashboard-workshop": {
    ...
    blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>\u0633\u064a\u0646\u0627\u0631\u064a\u0648 \u0627\u0644\u0648\u0631\u0634\u0629</h3>
      <p>\u0623\u0646\u062a \u062a\u0628\u0646\u064a \u0644\u0648\u062d\u0629 \u0645\u0639\u0644\u0648\u0645\u0627\u062a \u0645\u0628\u064a\u0639\u0627\u062a \u0644\u0645\u062f\u064a\u0631 \u0625\u0642\u0644\u064a\u0645\u064a. \u0627\u0644\u0635\u0641\u062d\u0629 \u0627\u0644\u062c\u064a\u062f\u0629 \u064a\u062c\u0628 \u0623\u0646 \u062a\u062c\u064a\u0628 \u0639\u0646 \u062b\u0644\u0627\u062b\u0629 \u0623\u0633\u0626\u0644\u0629:</p>
      <ul>
        <li>\u0647\u0644 \u0627\u0644\u0623\u062f\u0627\u0621 \u0623\u0639\u0644\u0649 \u0645\u0646 \u0627\u0644\u0647\u062f\u0641 \u0623\u0645 \u0623\u0642\u0644\u061f</li>
        <li>\u0645\u0627 \u0627\u0644\u0645\u0646\u0627\u0637\u0642 \u0623\u0648 \u0627\u0644\u0645\u0646\u062a\u062c\u0627\u062a \u0627\u0644\u062a\u064a \u062a\u0641\u0633\u0631 \u0627\u0644\u062a\u063a\u064a\u0631\u061f</li>
        <li>\u0645\u0627 \u0627\u0644\u0634\u064a\u0621 \u0627\u0644\u0630\u064a \u064a\u062c\u0628 \u0645\u062a\u0627\u0628\u0639\u062a\u0647 \u0647\u0630\u0627 \u0627\u0644\u0623\u0633\u0628\u0648\u0639\u061f</li>
      </ul>
    </div>
    ...
    <div class="lesson-card">
      ...
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>\u062d\u062f\u062f \u0627\u0644\u0642\u0631\u0627\u0631 \u0648\u0627\u0644\u062c\u0645\u0647\u0648\u0631</h4>
            <p>\u0627\u0643\u062a\u0628 \u0645\u0646 \u0633\u064a\u0633\u062a\u062e\u062f\u0645 \u0627\u0644\u062a\u0642\u0631\u064a\u0631 \u0648\u0645\u0627 \u0627\u0644\u0642\u0631\u0627\u0631 \u0627\u0644\u0645\u0637\u0644\u0648\u0628 \u0645\u0646\u0647.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            <h4>\u062c\u0647\u0632 \u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a</h4>
            <p>\u0646\u0638\u0641 \u0627\u0644\u062c\u062f\u0627\u0648\u0644\u060c \u0648\u0627\u0628\u0646\u0650 \u0627\u0644\u0639\u0644\u0627\u0642\u0627\u062a\u060c \u0648\u062a\u0623\u0643\u062f \u0645\u0646 \u062c\u0647\u0648\u0632\u064a\u0629 \u062c\u062f\u0648\u0644 \u0627\u0644\u062a\u0627\u0631\u064a\u062e.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>\u0627\u0628\u0646\u0650 \u0627\u0644\u0645\u0642\u0627\u064a\u064a\u0633 \u0627\u0644\u0623\u0633\u0627\u0633\u064a\u0629</h4>
            <p>\u0645\u062b\u0644 \u0627\u0644\u0645\u0628\u064a\u0639\u0627\u062a\u060c \u0627\u0644\u0631\u0628\u062d\u060c \u0646\u0633\u0628\u0629 \u0627\u0644\u0625\u0646\u062c\u0627\u0632\u060c \u0648\u0627\u0644\u0627\u0646\u062d\u0631\u0627\u0641 \u0639\u0646 \u0627\u0644\u0647\u062f\u0641.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">4</div>
          <div class="step-content">
            <h4>\u062e\u0637\u0637 \u0627\u0644\u0635\u0641\u062d\u0629 \u0642\u0628\u0644 \u0627\u0644\u062a\u0646\u0641\u064a\u0630</h4>
            <p>\u062d\u062f\u062f \u0645\u0643\u0627\u0646 \u0627\u0644\u0639\u0646\u0648\u0627\u0646\u060c \u0648\u0627\u0644\u0628\u0637\u0627\u0642\u0627\u062a\u060c \u0648\u0627\u0644\u0631\u0633\u0645 \u0627\u0644\u0631\u0626\u064a\u0633\u064a\u060c \u0648\u0627\u0644\u0641\u0644\u0627\u062a\u0631 \u0627\u0644\u0644\u0627\u0632\u0645\u0629.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-card">
      <h3>\u0642\u0627\u0626\u0645\u0629 \u0641\u062d\u0635 \u0642\u0628\u0644 \u0627\u0644\u062a\u0633\u0644\u064a\u0645</h3>
      <ul>
        <li><strong>\u0627\u0644\u0623\u0631\u0642\u0627\u0645 \u0645\u0648\u062b\u0648\u0642\u0629:</strong> \u0627\u062e\u062a\u0628\u0631 \u0627\u0644\u0645\u0642\u0627\u064a\u064a\u0633 \u0639\u0644\u0649 \u062c\u062f\u0648\u0644 \u0628\u0633\u064a\u0637.</li>
        <li><strong>\u0627\u0644\u0631\u0633\u0627\u0644\u0629 \u0648\u0627\u0636\u062d\u0629:</strong> \u064a\u0645\u0643\u0646 \u0641\u0647\u0645 \u0627\u0644\u0635\u0641\u062d\u0629 \u0641\u064a \u062b\u0648\u0627\u0646\u064d \u0642\u0644\u064a\u0644\u0629.</li>
        <li><strong>\u0644\u0627 \u064a\u0648\u062c\u062f \u0627\u0632\u062f\u062d\u0627\u0645:</strong> \u0643\u0644 \u0639\u0646\u0635\u0631 \u0644\u0647 \u062f\u0648\u0631 \u0648\u0627\u0636\u062d.</li>
      </ul>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Workshop scenario</h3>
      <p>You are building a sales dashboard for a regional manager. A strong page should answer three things:</p>
      <ul>
        <li>Is performance above or below target?</li>
        <li>Which regions or products explain the shift?</li>
        <li>What should be reviewed this week?</li>
      </ul>
    </div>
    ...
    <div class="lesson-card">
      ...
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
            <h4>Define the decision and audience</h4>
            <p>Write who will use the page and what decision it should support.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <div class="step-content">
            ...
            <p>Clean the tables, build the relationships, and confirm the date table is ready.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <div class="step-content">
            <h4>Build the core measures</h4>
            <p>Such as sales, profit, achievement, and target variance.</p>
          </div>
        </div>
        <div class="step">
          <div class="step-num">4</div>
          <div class="step-content">
            <h4>Plan the page before building</h4>
            <p>Decide where the title, cards, dominant visual, and filters will sit.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>The numbers are trusted:</strong> validate measures in a simple table first.</li>
        <li><strong>The message is clear:</strong> the page should be readable in a few seconds.</li>
        <li><strong>There is no clutter:</strong> every visual should have a purpose.</li>
      </ul>
    </div>` }],
  },
  "error-handling": {
    ...
    en_lede: "How to read Power BI error messages, trace them to their source, and fix them without guessing.",
    ...
    <div class="lesson-card">
      <h3>استراتأتية Debugging في DAX</h3>
...
<code style="display:block; background:var(--ink-light); padding:10px; margin:10px 0; border-radius:4px;">Has Error = IF(ISERROR(DIVIDE(A, B)), 1, 0)</code>
  ...
  "semantic-model": {
    ...
    en_lede: "Naming conventions, documentation, and structure decisions that keep models maintainable long after you've moved on.",
...
<p>Not just a model that works, but a model that's <strong>easily understood</strong> by anyone who uses or maintains it.</p>
...
<li>Compare with Excel or SQL</li>
  ...
  "data-governance": {
    ...
    blocks: [
      { kind: "html", html: `
<div class="lesson-card">
  <h3>ركائز حوكمة البيانات في Power BI</h3>
  <div class="lesson-card-body">
    <p>Power BI يُوفّر أدوات متكاملة لحوكمة البيانات على مستويين: <strong>حماية المحتوى</strong> (Sensitivity Labels) و<strong>إدارة الثقة</strong> (Endorsement + Lineage).</p>
    <div class="compare-table">
      <table>
        <thead><tr><th>الأداة</th><th>الوظيفة</th></tr></thead>
        <tbody>
          <tr><td><strong>Sensitivity Labels</strong></td><td>تصنيف البيانات: عام / داخلي / سري / شديد السرية</td></tr>
          <tr><td><strong>Endorsement</strong></td><td>الترويج: Promoted أو Certified للتمييز بين المصادر الموثوقة</td></tr>
          <tr><td><strong>Data Lineage</strong></td><td>خريطة تدفق البيانات من المصدر إلى التقرير النهائي</td></tr>
          <tr><td><strong>Impact Analysis</strong></td><td>ما الذي سيتأثر إذا غيّرت هذا Dataset؟</td></tr>
        </tbody>
      </table>
    </div>
  </div>
      ...
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Sensitivity Labels — تصنيف المعلومات</h3>
  <div class="lesson-card-body">
    <p>Sensitivity Labels (من Microsoft Purview) تُصنّف ملفات Power BI وتُطبّق سياسات الحماية تلقائياً — مثل التشفير عند التصدير إلى Excel.</p>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>الإعداد:</strong> يتطلب Microsoft 365 E3/E5 أو Microsoft Purview. مسؤول IT يُنشئ التصنيفات في Microsoft Purview Compliance Portal
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>التطبيق في Desktop:</strong> الصفحة الرئيسية → Sensitivity → اختر مستوى التصنيف (General / Confidential / Highly Confidential)
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>التوريث التلقائي:</strong> Dataset المُصنَّف يُورث تصنيفه تلقائياً للتقارير المبنية عليه — يمنع تسريب البيانات الحساسة عبر التقارير الجديدة
      </div></div>
    </div>
    <div class="tip-box">
      <strong>الحماية عند التصدير:</strong> البيانات المُصنَّفة بـ Confidential تُشفَّر عند التصدير إلى Excel أو PDF — فقط المُصرَّح لهم يفتحونها.
    </div>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Endorsement — نظام الثقة والترويج</h3>
  <div class="lesson-card-body">
    <p>Endorsement يُميّز بين مصادر البيانات الموثوقة والتجريبية. بدونه، المستخدمون لا يعرفون أي Dataset هو "الرسمي" وأيها تجربة شخصية.</p>
    <ul>
      <li><strong>Promoted:</strong> يُمكن لأي صاحب Dataset ترقيته — يُشير إلى أنه مُعدٌّ للاستخدام العام</li>
      <li><strong>Certified:</strong> يتطلب صلاحية خاصة يمنحها مسؤول Tenant — يعني أن Dataset اجتاز مراجعة الجودة الرسمية</li>
    </ul>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>الترقية:</strong> في Service → Dataset → Settings → Endorsement → Promoted. أضف وصفاً يُوضّح للمستخدمين ما يحتوي عليه
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>الظهور في البحث:</strong> المصادر المُروَّجة أو المُعتمَدة تظهر في أعلى نتائج البحث في Power BI Service — المستخدمون يجدون "الصحيح" أولاً
      </div></div>
    </div>
    <div class="warn-box">
      <strong>سياسة مؤسسية:</strong> ضع معياراً واضحاً لمن يستطيع ترقية Dataset إلى Certified — التساهل يُفرغ المفهوم من معناه.
    </div>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Data Lineage و Impact Analysis</h3>
  <div class="lesson-card-body">
    <p>Data Lineage تُظهر خريطة بصرية لتدفق البيانات: من مصادر البيانات → Dataflows → Datasets → التقارير → لوحات المعلومات. أداة لا تقدر بثمن عند تشخيص مشكلة أو التخطيط لتغيير.</p>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>الوصول:</strong> في مجموعة العمل → اضغط زر "Lineage View" في الأعلى. ترى كل عناصر مجموعة العمل مُرتبطة ببعض
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>قراءة الخريطة:</strong> اتبع الأسهم من اليسار إلى اليمين: مصدر البيانات ← Dataflow ← Dataset ← تقارير ← لوحات معلومات
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>Impact Analysis:</strong> انقر على أي Dataset → "Impact Analysis" → ترى: كم تقريراً يعتمد عليه؟ كم مستخدماً؟ من يجب إخباره قبل تغيير هذا Dataset؟
      </div></div>
    </div>
    <div class="tip-box">
      <strong>سيناريو عملي:</strong> قبل تعديل اسم عمود في Dataset مشترك، افتح Impact Analysis — قد تجد 12 تقريراً تعتمد عليه و200 مستخدم يُتأثرون بالتغيير.
    </div>
  </div>
</div>` },
    ],
    en_blocks: [
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Data Governance Pillars in Power BI</h3>
  <div class="lesson-card-body">
    <p>Power BI provides integrated tools for data governance across two dimensions: <strong>content protection</strong> (Sensitivity Labels) and <strong>trust management</strong> (Endorsement + Lineage).</p>
    <div class="compare-table">
      <table>
        <thead><tr><th>Tool</th><th>Function</th></tr></thead>
        <tbody>
          <tr><td><strong>Sensitivity Labels</strong></td><td>Classify data: Public / Internal / Confidential / Highly Confidential</td></tr>
          <tr><td><strong>Endorsement</strong></td><td>Promote trust: Promoted or Certified to distinguish reliable sources</td></tr>
          <tr><td><strong>Data Lineage</strong></td><td>Visual map of data flow from source to final report</td></tr>
          <tr><td><strong>Impact Analysis</strong></td><td>What will be affected if you change this dataset?</td></tr>
        </tbody>
      </table>
    </div>
  </div>
      ...
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Sensitivity Labels — Classifying Information</h3>
  <div class="lesson-card-body">
    <p>Sensitivity Labels (from Microsoft Purview) classify Power BI files and automatically apply protection policies — like encryption when exporting to Excel.</p>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>Setup:</strong> Requires Microsoft 365 E3/E5 or Microsoft Purview. An IT admin creates the labels in Microsoft Purview Compliance Portal
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>Apply in Desktop:</strong> Home tab → Sensitivity → Choose the classification level (General / Confidential / Highly Confidential)
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>Automatic inheritance:</strong> A labeled dataset automatically passes its label to reports built on top of it — preventing sensitive data from leaking through new reports
      </div></div>
    </div>
    <div class="tip-box">
      <strong>Export protection:</strong> Data labeled Confidential is encrypted when exported to Excel or PDF — only authorized users can open it.
    </div>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Endorsement — Building a Trust System</h3>
  <div class="lesson-card-body">
    <p>Endorsement distinguishes trusted data sources from experimental ones. Without it, users can't tell which dataset is "official" versus a personal experiment.</p>
    <ul>
      <li><strong>Promoted:</strong> Any dataset owner can set this — signals the dataset is ready for general use</li>
      <li><strong>Certified:</strong> Requires a special permission granted by a Tenant admin — means the dataset has passed formal quality review</li>
    </ul>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>Promote:</strong> In Service → Dataset → Settings → Endorsement → Promoted. Add a description so users know what it contains
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>Visibility in search:</strong> Promoted and Certified sources appear at the top of search results in Power BI Service — users find the "right" one first
      </div></div>
    </div>
    <div class="warn-box">
      <strong>Organizational policy:</strong> Define clear criteria for who can promote a dataset to Certified — being too loose empties the concept of meaning.
    </div>
  </div>
</div>` },
      { kind: "html", html: `
<div class="lesson-card">
  <h3>Data Lineage and Impact Analysis</h3>
  <div class="lesson-card-body">
    <p>Data Lineage shows a visual map of data flow: data sources → Dataflows → Datasets → Reports → Dashboards. Invaluable when diagnosing a problem or planning a change.</p>
    <div class="steps">
      <div class="step"><div class="step-num">1</div><div class="step-content">
        <strong>Access it:</strong> In your workspace → click the "Lineage View" button at the top. You'll see all workspace items connected together
      </div></div>
      <div class="step"><div class="step-num">2</div><div class="step-content">
        <strong>Read the map:</strong> Follow arrows left to right: data source ← Dataflow ← Dataset ← Reports ← Dashboards
      </div></div>
      <div class="step"><div class="step-num">3</div><div class="step-content">
        <strong>Impact Analysis:</strong> Click any Dataset → "Impact Analysis" → see: how many reports depend on it, how many users, and who to notify before making changes
      </div></div>
    </div>
    <div class="tip-box">
      <strong>Real-world scenario:</strong> Before renaming a column in a shared dataset, open Impact Analysis — you might find 12 reports depending on it and 200 users affected by the change.
    </div>
  </div>
</div>` },
    ],
  ...
  "common-mistakes": {
    ...
    en_lede: "The most common Power BI mistakes — wrong relationships, bad context, poor model design — and how to avoid them.",
  ...
  "cost-optimization": {
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li>لا تحتاج استراتأتيات تقدمة (Python, R)</li>
      </ul>
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li>استخدم Shared Capacity بدلاً من Premium إذا أمكن</li>
...
<li>But... PPU gives faster updates for 20 key users! ✅</li>
  ...
  "power-automate": {
    ...
    en_lede: "Trigger emails, Teams messages, and workflows automatically when a KPI crosses a threshold.",
...
<p><strong>Result:</strong> Instant notification when sales drop! ⚡</p>
  ...
  "auto-refresh": {
    ...
    en_lede: "Schedule dataset refresh, handle failures gracefully, and monitor what's actually running in your workspace.",
...
<p><strong>Golden Equation:</strong> Refresh Frequency = Data Change Rate. If data changes every hour, refresh every hour. If it changes weekly, refresh weekly.</p>
  ...
  "automate-reports": {
    ...
    en_lede: "Deliver reports automatically to users on a schedule — no manual exports, no forgotten sends.",
...
SUMX(
    ...
    <div class="lesson-card">
      ...
      <p>The issue isn't that many-to-many can never exist. The issue is using it as a quick fix without understanding filter flow.</p>
    ...
    <div class="tip-box">
      <div class="icon">?</div>
      <p><strong>Checklist before release:</strong> do you have a date table, clean measures, intentional relationships, and a performance review? If any answer is no, the practical answer is simple: don't ship yet.</p>
    </div>` }],
  },
  ...
  "external-tools": {
    ...
    <div class="lesson-card">
      ...
      <p>The goal isn't to open the tool for its own sake. The goal is to leave with a concrete decision: remove a column, simplify a measure, or redesign part of the model.</p>
    </div>
...
<span class="cm">5) Filters / RLS / role assignment تحدد ما الذي يراه المستخدم</span>
    ...
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Three different use cases you shouldn't mix up</h3>
      <ul>
    ...
    <div class="lesson-card">
      ...
      <p>A Service Principal isn't an encryption method. It is a non-human application identity used for automation and system-to-system communication.</p>
      <ul>
        ...
        <li>It doesn't replace good model security or good workspace design.</li>
      </ul>
    </div>
...
5) RLS, filters, and role assignments limit what the user sees
    ...
    <div class="warn-box">
      <div class="icon">!</div>
      <p><strong>Important warning:</strong> embedding doesn't remove the need for RLS, OLS, or sane permissions. If your design assumes that one token can safely open everything, you're building a vulnerability, not a product.</p>
    </div>` }],
  },
...
Project/
  ...
  release-checklist.md
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>أفضل نقطة بداية:</strong> إذا فريقك صغير، لا تبدأ بمشهد DevOps ضخم. ابدأ بـ PBIP + Git + release checklist + بيئات واضحة. ثم أضف pipeline عندما تصبح الحاجة حقيقية.</p>
    </div>` }],
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
...
Project/
  ...
  release-checklist.md
      ...
      <p>What usually doesn't belong there: temporary exports, binaries you can't review meaningfully, and secrets or tokens.</p>
    </div>
    ...
    <div class="tip-box">
      <div class="icon">?</div>
      <p><strong>Best starting point:</strong> if your team is small, don't begin with a giant DevOps theater. Start with PBIP, Git, a release checklist, and clear environments. Add pipelines when the need becomes real.</p>
    </div>` }],
  },
  ...
  "advanced-dataflows": {
    ...
    <div class="warn-box">
      <div class="icon">!</div>
      <p><strong>Important:</strong> Dataflows aren't automatically better than Desktop Power Query. They are valuable when they buy you centralization, reuse, and cloud execution. Without those benefits, they may add complexity without real return.</p>
    </div>` }],
  },
...
Time Intelligence
  ...
  - YoY %
    ...
    <div class="lesson-card">
      ...
      <p>Power BI Desktop doesn't provide full interface. Use Tabular Editor:</p>
      <div class="steps">
        <div class="step">
          <div class="step-num">1</div>
          <div class="step-content">
...
[Manager ID] matches [User Principal Name] from a linked Security table
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li>Cairo managers should only see Cairo rows: that's RLS.</li>
        <li>Most managers shouldn't see cost or internal margin details: that's OLS or a safer model design.</li>
        <li>A central BI analyst should be allowed to build a new report on the same model: that's Build permission.</li>
        <li>End users should consume a finished app instead of browsing the workspace: that's an access decision, not just an RLS decision.</li>
      </ul>
    </div>

    <div class="warn-box">
      <div class="icon">!</div>
      <p><strong>Common mistake:</strong> giving broad workspace access and then saying "we have RLS." RLS doesn't fix weak workspace permissions, unnecessary Build rights, or the wrong content entry path.</p>
    </div>

    <div class="tip-box">
      <div class="icon">?</div>
      <p><strong>Security design rule:</strong> start from the question "what's the minimum access this role needs?" Strong Power BI security follows least privilege, not maximum convenience.</p>
    </div>` }],
  },
  ...
  "deployment-pipelines": {
    ...
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <p>If you develop directly in Prod, you aren't managing a product. You are testing on users.</p>
    </div>
    ...
    <div class="steps">
      ...
      <div class="step">
        ...
        <div class="step-content">
          ...
          <p>Use Deployment Pipelines or ALM Toolkit to compare and move changes in a controlled, structured way. Environment-specific settings such as credentials and parameters must be reviewed, not assumed.</p>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-card">
      ...
      <p>It is especially valuable when the real question isn't "can we deploy?" but "what exactly will change if we do?"</p>
    </div>
  ...
  "monitoring-adoption": {
    ...
    <div class="lesson-card">
      ...
      <ul>
        <li><strong>Success Rate:</strong> إذا أقل من 95% في الشهر الأخير، هناك مشكلة نظامية (Data Gateway issues، source database down).</li>
        <li><strong>Duration Trend:</strong> إذا الـ refresh بدأت تأخذ ساعتين بدل 20 دقيقة، هناك bloat في البيانات أو query performance issue.</li>
    ...
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      ...
      <p>These measures tell you whether the report is stable, whether it's adopted, and whether parts of it are wasted complexity.</p>
    </div>
    ...
    <div class="tip-box">
      <div class="icon">💡</div>
      <p><strong>Important tip:</strong> Adoption studies aren't instantaneous. Wait 4-6 weeks minimum before judging. Good reports need time for teams to embed them into their routine workflow.</p>
    </div>` }],
  },
  ...
  "project-retail-starter": {
    ...
    en_lede: "Build a full retail analytics report from scratch: data modeling, relationships, DAX measures, and a clean dashboard.",
...
└─────────────────────────────────────────┘
    ...
    <div class="steps">
      ...
      <div class="step">
        ...
        <div class="step-content">
          ...
          <p>The report should help staffing, menu mix, and promotion decisions. It isn't just a student exercise in colorful visuals.</p>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-card">
      <h3>Definition of Done</h3>
      <ul>
        <li>Relationships are clean and revenue isn't duplicated by bad joins.</li>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>Dataset type:</strong> multi-table CSV package that's ideal for early star-schema practice without overwhelming scale.</li>
  ...
  "project-ops-intermediate": {
    ...
    en_lede: "One raw table, dozens of insights. This project teaches you to build a rich semantic layer from minimal source data.",
...
└─────────────────────────────────────┘
    ...
    en_blocks: [{ kind: "html", html: `<div class="lesson-card">
      <h3>Project scenario</h3>
      <p>You are building an analytical report for more than 20,000 Lichess games. The goal isn't just to count wins, but to explain how rating difference, time control, and opening choice affect results.</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <p>The challenge here isn't joins. The challenge is converting a raw table into an analytical model with meaningful derived categories.</p>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li>The report doesn't dump the moves text into visuals without analytical purpose.</li>
      </ul>
    </div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>Why it's a strong intermediate project:</strong> it forces you to create semantic layers, buckets, flags, and analytical groupings by yourself.</li>
        <li><strong>Last verified:</strong> 2026-04-22.</li>
      </ul>
    </div>
...
└─────────────────────────────────────┘
  ...
  "project-enterprise-advanced": {
    ...
    en_lede: "Large-scale Airbnb data, geographic analysis, and review metrics — a portfolio-worthy enterprise project.",
    ...
    <div class="lesson-card">
      ...
      <p>The first modeling decision is already advanced: listing grain isn't review grain, and mixing them carelessly will distort price, rating, and count metrics.</p>
    </div>
    ...
    <div class="steps">
      <div class="step">
        ...
        <div class="step-content">
          ...
          <p>A listing isn't a review. Do not join review history directly into listing metrics without understanding how repetition affects averages, counts, and ratios.</p>
        </div>
      </div>
      <div class="step">
        <div class="step-num">2</div>
        <div class="step-content">
          ...
          <p>You don't have to expose every raw review row in the final report. Sometimes a summarized monthly or city-level layer is the more professional performance decision.</p>
        </div>
      </div>
      <div class="step">
        <div class="step-num">3</div>
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>Why it's advanced:</strong> large volume, multiple cities, review history, and simultaneous geographic and behavioral analysis.</li>
        <li><strong>Last verified:</strong> 2026-04-22.</li>
      </ul>
    </div>
    ...
    <div class="tip-box">
      <div class="icon">?</div>
      <p><strong>Success here isn't the number of pages.</strong> Success is building a model that separates grains clearly, justifies each KPI, and stays performant despite large data volume.</p>
    </div>
...
└────────────────────────────────────────────┘
  ...
  "portfolio-playbook": {
    ...
    en_lede: "Finishing a project is only half the work. This lesson shows you how to present it so it actually demonstrates your skill.",
...
7. What I Would Improve Next
    ...
    <div class="lesson-card">
      ...
      <ul>
        ...
        <li><strong>Why it isn't in the core three:</strong> the site currently uses three main project slots, so this works best as an optional extra portfolio piece.</li>
      </ul>
    </div>

    <div class="tip-box">
      <div class="icon">?</div>
      <p><strong>The best portfolio isn't the biggest one.</strong> It is the one that shows clear thinking: a defined problem, a logical model, trustworthy measures, and architectural decisions you can explain calmly.</p>
    </div>` }],
  },
});
